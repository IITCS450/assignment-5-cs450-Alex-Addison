...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      40:	80 3d 22 1e 00 00 20 	cmpb   $0x20,0x1e22
...
fork1(void)
{
  ...
  memset(buf, 0, nbuf);
      ...
      79:	6a 64                	push   $0x64
      7b:	6a 00                	push   $0x0
      7d:	68 20 1e 00 00       	push   $0x1e20
      82:	e8 09 0c 00 00       	call   c90 <memset>
  gets(buf, nbuf);
      87:	58                   	pop    %eax
      88:	5a                   	pop    %edx
      89:	6a 64                	push   $0x64
      8b:	68 20 1e 00 00       	push   $0x1e20
      90:	e8 5b 0c 00 00       	call   cf0 <gets>
  if(buf[0] == 0) // EOF
      95:	0f b6 05 20 1e 00 00 	movzbl 0x1e20,%eax
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      a7:	80 3d 21 1e 00 00 64 	cmpb   $0x64,0x1e21
     ...
     100:	51                   	push   %ecx
     101:	68 23 1e 00 00       	push   $0x1e23
     106:	68 3d 16 00 00       	push   $0x163d
     10b:	6a 02                	push   $0x2
  ...
  exit();
    ...
    panic("fork");
     ...
     122:	68 97 15 00 00       	push   $0x1597
...
00000130 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     13e:	68 94 15 00 00       	push   $0x1594
     143:	6a 02                	push   $0x2
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 31 16 00 00       	push   $0x1631
     17e:	6a 02                	push   $0x2
...
00000190 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     1a5:	68 97 15 00 00       	push   $0x1597
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 4c 16 00 00 	jmp    *0x164c(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1e9:	68 a3 15 00 00       	push   $0x15a3
     1ee:	6a 02                	push   $0x2
    ...
    panic("runcmd");
     ...
     2cf:	68 c3 15 00 00       	push   $0x15c3
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 fc 1d 00 00       	push   $0x1dfc
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 fc 1d 00 00       	push   $0x1dfc
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 f4 1d 00 00       	push   $0x1df4
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 fc 1d 00 00       	push   $0x1dfc
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 fc 1d 00 00       	push   $0x1dfc
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 e5 15 00 00       	push   $0x15e5
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  return cmd;
     ...
     77e:	68 c8 15 00 00       	push   $0x15c8
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     79f:	68 e8 15 00 00       	push   $0x15e8
     7a4:	57                   	push   %edi
     7a5:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     806:	68 ff 15 00 00       	push   $0x15ff
     80b:	57                   	push   %edi
     80c:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     850:	68 f1 15 00 00       	push   $0x15f1
  ...
  cmd->eargv[argc] = 0;
     ...
     899:	68 ea 15 00 00       	push   $0x15ea
...
000008b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8c9:	68 04 16 00 00       	push   $0x1604
  cmd = parseexec(ps, es);
...
00000940 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     99b:	68 06 16 00 00       	push   $0x1606
     9a0:	57                   	push   %edi
     9a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9b1:	68 02 16 00 00       	push   $0x1602
     9b6:	57                   	push   %edi
     9b7:	56                   	push   %esi
...
00000a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a2f:	68 e8 15 00 00       	push   $0x15e8
     a34:	56                   	push   %esi
     a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a59:	68 24 16 00 00       	push   $0x1624
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ac9:	ff 24 85 64 16 00 00 	jmp    *0x1664(,%eax,4)
     ...
     b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b83:	68 b2 15 00 00       	push   $0x15b2
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     bae:	52                   	push   %edx
     baf:	50                   	push   %eax
     bb0:	68 26 16 00 00       	push   $0x1626
     bb5:	6a 02                	push   $0x2
     bb7:	e8 c4 03 00 00       	call   f80 <printf>
    panic("syntax");
     bbc:	c7 04 24 ea 15 00 00 	movl   $0x15ea,(%esp)
     ...
     edc:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f09:	0f b6 92 dc 16 00 00 	movzbl 0x16dc(%edx),%edx
     ...
     f89:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     ff9:	ff 24 85 84 16 00 00 	jmp    *0x1684(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    1107:	90                   	nop
          s = "(null)";
    1108:	ba 7c 16 00 00       	mov    $0x167c,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1121:	a1 84 1e 00 00       	mov    0x1e84,%eax
{
  ...
  freep = p;
    ...
    1161:	5b                   	pop    %ebx
  freep = p;
    1162:	89 15 84 1e 00 00    	mov    %edx,0x1e84
}
    1168:	5e                   	pop    %esi
    1169:	5f                   	pop    %edi
    116a:	5d                   	pop    %ebp
  ...
  freep = p;
    119c:	89 15 84 1e 00 00    	mov    %edx,0x1e84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    11bc:	8b 3d 84 1e 00 00    	mov    0x1e84,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1201:	8b 3d 84 1e 00 00    	mov    0x1e84,%edi
  ...
  return freep;
    122f:	8b 15 84 1e 00 00    	mov    0x1e84,%edx
    ...
    125c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    125f:	89 15 84 1e 00 00    	mov    %edx,0x1e84
}
    ...
    126f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1270:	c7 05 84 1e 00 00 88 	movl   $0x1e88,0x1e84
    1277:	1e 00 00 
    base.s.size = 0;
    127a:	bf 88 1e 00 00       	mov    $0x1e88,%edi
    base.s.ptr = freep = prevp = &base;
    127f:	c7 05 88 1e 00 00 88 	movl   $0x1e88,0x1e88
    1286:	1e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1289:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    128b:	c7 05 8c 1e 00 00 00 	movl   $0x0,0x1e8c
    1292:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
  ...
  for (i = 0; i < MAX_THREADS; i++) {
    ...
    12b0:	c7 05 d4 1e 00 00 00 	movl   $0x0,0x1ed4
    12b7:	00 00 00 
    12ba:	c7 05 e4 1e 00 00 00 	movl   $0x0,0x1ee4
    12c1:	00 00 00 
    12c4:	c7 05 f4 1e 00 00 00 	movl   $0x0,0x1ef4
    12cb:	00 00 00 
    12ce:	c7 05 04 1f 00 00 00 	movl   $0x0,0x1f04
    12d5:	00 00 00 
    12d8:	c7 05 14 1f 00 00 00 	movl   $0x0,0x1f14
    12df:	00 00 00 
    12e2:	c7 05 24 1f 00 00 00 	movl   $0x0,0x1f24
    12e9:	00 00 00 
    12ec:	c7 05 34 1f 00 00 00 	movl   $0x0,0x1f34
    12f3:	00 00 00 
  }
  current_thread = &thread_table[0];
    12f6:	c7 05 a0 1e 00 00 c0 	movl   $0x1ec0,0x1ea0
    12fd:	1e 00 00 
  current_thread->state = RUNNING;
    1300:	c7 05 c4 1e 00 00 02 	movl   $0x2,0x1ec4
    1307:	00 00 00 
  current_thread->tid = 0;
    130a:	c7 05 cc 1e 00 00 00 	movl   $0x0,0x1ecc
    1311:	00 00 00 
}
    1314:	c3                   	ret    
...
tid_t thread_create(void (*fn)(void*), void *arg) {
    ...
    1330:	89 c3                	mov    %eax,%ebx
    1332:	c1 e3 04             	shl    $0x4,%ebx
    1335:	8b 93 c4 1e 00 00    	mov    0x1ec4(%ebx),%edx
    133b:	85 d2                	test   %edx,%edx
    133d:	74 19                	je     1358 <thread_create+0x38>
  for (i = 0; i < MAX_THREADS; i++) {
    133f:	83 c0 01             	add    $0x1,%eax
    1342:	83 f8 08             	cmp    $0x8,%eax
    1345:	75 e9                	jne    1330 <thread_create+0x10>
  ...
  t->stack = malloc(STACK_SIZE);
    ...
    135b:	68 00 10 00 00       	push   $0x1000
    1360:	e8 4b fe ff ff       	call   11b0 <malloc>
  sp -= 4; *(uint*)sp = (uint)arg;
    1365:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  t->tid = (int)(t - thread_table);
    1368:	83 c4 10             	add    $0x10,%esp
  t->state = RUNNABLE;
    136b:	c7 83 c4 1e 00 00 01 	movl   $0x1,0x1ec4(%ebx)
    1372:	00 00 00 
  t->stack = malloc(STACK_SIZE);
    1375:	89 83 c0 1e 00 00    	mov    %eax,0x1ec0(%ebx)
  sp -= 4; *(uint*)sp = (uint)arg;
    137b:	89 88 fc 0f 00 00    	mov    %ecx,0xffc(%eax)
  sp -= 4; *(uint*)sp = (uint)fn;
    1381:	8b 4d 08             	mov    0x8(%ebp),%ecx
  sp -= 4; *(uint*)sp = 0;
    1384:	c7 80 f4 0f 00 00 00 	movl   $0x0,0xff4(%eax)
    138b:	00 00 00 
  sp -= 4; *(uint*)sp = (uint)fn;
    138e:	89 88 f8 0f 00 00    	mov    %ecx,0xff8(%eax)
  sp -= sizeof(struct context);
    1394:	8d 88 e0 0f 00 00    	lea    0xfe0(%eax),%ecx
  t->context->eip = (uint)thread_stub;
    139a:	c7 80 f0 0f 00 00 70 	movl   $0x1470,0xff0(%eax)
    13a1:	14 00 00 
  t->tid = (int)(t - thread_table);
    13a4:	89 d8                	mov    %ebx,%eax
    13a6:	c1 f8 04             	sar    $0x4,%eax
  sp -= sizeof(struct context);
    13a9:	89 8b c8 1e 00 00    	mov    %ecx,0x1ec8(%ebx)
  t->tid = (int)(t - thread_table);
    13af:	89 83 cc 1e 00 00    	mov    %eax,0x1ecc(%ebx)
}
    13b5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    13b8:	c9                   	leave  
    13b9:	c3                   	ret    
    13ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

000013c0 <thread_yield>:
...
void thread_yield(void) {
  ...
  struct thread *prev = current_thread;
    13c9:	8b 35 a0 1e 00 00    	mov    0x1ea0,%esi
  struct thread *next = 0;
  int i, idx;
  int start = (prev->tid + 1) % MAX_THREADS;
    13cf:	8b 46 0c             	mov    0xc(%esi),%eax
    13d2:	83 c0 01             	add    $0x1,%eax
    13d5:	99                   	cltd   
    13d6:	c1 ea 1d             	shr    $0x1d,%edx
    13d9:	01 d0                	add    %edx,%eax
    13db:	83 e0 07             	and    $0x7,%eax
    13de:	29 d0                	sub    %edx,%eax
    13e0:	8d 58 08             	lea    0x8(%eax),%ebx
    13e3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    13e7:	90                   	nop

  for (i = 0; i < MAX_THREADS; i++) {
    idx = (start + i) % MAX_THREADS;
    13e8:	89 c1                	mov    %eax,%ecx
    13ea:	c1 f9 1f             	sar    $0x1f,%ecx
    13ed:	c1 e9 1d             	shr    $0x1d,%ecx
    13f0:	8d 14 08             	lea    (%eax,%ecx,1),%edx
    13f3:	83 e2 07             	and    $0x7,%edx
    13f6:	29 ca                	sub    %ecx,%edx
    if (thread_table[idx].state == RUNNABLE) {
    13f8:	89 d1                	mov    %edx,%ecx
    13fa:	c1 e1 04             	shl    $0x4,%ecx
    13fd:	83 b9 c4 1e 00 00 01 	cmpl   $0x1,0x1ec4(%ecx)
    1404:	8d b9 c0 1e 00 00    	lea    0x1ec0(%ecx),%edi
    140a:	74 14                	je     1420 <thread_yield+0x60>
  for (i = 0; i < MAX_THREADS; i++) {
    140c:	83 c0 01             	add    $0x1,%eax
    140f:	39 c3                	cmp    %eax,%ebx
    1411:	75 d5                	jne    13e8 <thread_yield+0x28>
    ...
    141f:	90                   	nop
  if (next && next != prev) {
    1420:	39 fe                	cmp    %edi,%esi
    1422:	74 ef                	je     1413 <thread_yield+0x53>
    if (prev->state == RUNNING) prev->state = RUNNABLE;
    1424:	83 7e 04 02          	cmpl   $0x2,0x4(%esi)
    1428:	74 36                	je     1460 <thread_yield+0xa0>
    uswtch(&prev->context, next->context);
    142a:	83 ec 08             	sub    $0x8,%esp
    next->state = RUNNING;
    142d:	c1 e2 04             	shl    $0x4,%edx
    uswtch(&prev->context, next->context);
    1430:	83 c6 08             	add    $0x8,%esi
    current_thread = next;
    1433:	89 3d a0 1e 00 00    	mov    %edi,0x1ea0
    uswtch(&prev->context, next->context);
    1439:	ff b2 c8 1e 00 00    	pushl  0x1ec8(%edx)
    143f:	56                   	push   %esi
    next->state = RUNNING;
    1440:	c7 82 c4 1e 00 00 02 	movl   $0x2,0x1ec4(%edx)
    1447:	00 00 00 
    uswtch(&prev->context, next->context);
    144a:	e8 2f 01 00 00       	call   157e <uswtch>
    144f:	83 c4 10             	add    $0x10,%esp
}
    1452:	8d 65 f4             	lea    -0xc(%ebp),%esp
    1455:	5b                   	pop    %ebx
    1456:	5e                   	pop    %esi
    1457:	5f                   	pop    %edi
    1458:	5d                   	pop    %ebp
    ...
    if (prev->state == RUNNING) prev->state = RUNNABLE;
    1460:	c7 46 04 01 00 00 00 	movl   $0x1,0x4(%esi)
    1467:	eb c1                	jmp    142a <thread_yield+0x6a>
    1469:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00001470 <thread_stub>:
void thread_stub(void (*fn)(void*), void *arg) {
    1470:	55                   	push   %ebp
    1471:	89 e5                	mov    %esp,%ebp
    1473:	83 ec 14             	sub    $0x14,%esp
  fn(arg);
    1476:	ff 75 0c             	pushl  0xc(%ebp)
    1479:	ff 55 08             	call   *0x8(%ebp)
  current_thread->state = ZOMBIE;
    147c:	a1 a0 1e 00 00       	mov    0x1ea0,%eax
  thread_yield();
    1481:	83 c4 10             	add    $0x10,%esp
  current_thread->state = ZOMBIE;
    1484:	c7 40 04 03 00 00 00 	movl   $0x3,0x4(%eax)
}
    148b:	c9                   	leave  
  thread_yield();
    148c:	e9 2f ff ff ff       	jmp    13c0 <thread_yield>
    1491:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1498:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    149f:	90                   	nop

000014a0 <thread_join>:
...
int thread_join(tid_t tid) {
    ...
    14a9:	8b 75 08             	mov    0x8(%ebp),%esi
  if (tid < 0 || tid >= MAX_THREADS) return -1;
    14ac:	83 fe 07             	cmp    $0x7,%esi
    14af:	77 6f                	ja     1520 <thread_join+0x80>

  while (thread_table[tid].state != ZOMBIE && thread_table[tid].state != UNUSED) {
    14b1:	89 f3                	mov    %esi,%ebx
    14b3:	c1 e3 04             	shl    $0x4,%ebx
    14b6:	81 c3 c0 1e 00 00    	add    $0x1ec0,%ebx
    14bc:	8b 43 04             	mov    0x4(%ebx),%eax
    14bf:	83 f8 03             	cmp    $0x3,%eax
    14c2:	75 19                	jne    14dd <thread_join+0x3d>
    14c4:	eb 1b                	jmp    14e1 <thread_join+0x41>
    14c6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    14cd:	8d 76 00             	lea    0x0(%esi),%esi
    thread_yield();
    14d0:	e8 eb fe ff ff       	call   13c0 <thread_yield>
  while (thread_table[tid].state != ZOMBIE && thread_table[tid].state != UNUSED) {
    14d5:	8b 43 04             	mov    0x4(%ebx),%eax
    14d8:	83 f8 03             	cmp    $0x3,%eax
    14db:	74 04                	je     14e1 <thread_join+0x41>
    14dd:	85 c0                	test   %eax,%eax
    14df:	75 ef                	jne    14d0 <thread_join+0x30>
  ...
  return 0;
    14e1:	31 db                	xor    %ebx,%ebx
  if (thread_table[tid].state == ZOMBIE) {
    14e3:	83 f8 03             	cmp    $0x3,%eax
    14e6:	74 10                	je     14f8 <thread_join+0x58>
    14e8:	8d 65 f4             	lea    -0xc(%ebp),%esp
    14eb:	89 d8                	mov    %ebx,%eax
    14ed:	5b                   	pop    %ebx
    14ee:	5e                   	pop    %esi
    14ef:	5f                   	pop    %edi
    14f0:	5d                   	pop    %ebp
    ...
    free(thread_table[tid].stack);
    14f8:	c1 e6 04             	shl    $0x4,%esi
    14fb:	83 ec 0c             	sub    $0xc,%esp
    14fe:	ff b6 c0 1e 00 00    	pushl  0x1ec0(%esi)
    1504:	e8 17 fc ff ff       	call   1120 <free>
    thread_table[tid].state = UNUSED;
    1509:	83 c4 10             	add    $0x10,%esp
    150c:	89 d8                	mov    %ebx,%eax
    thread_table[tid].state = UNUSED;
    150e:	c7 86 c4 1e 00 00 00 	movl   $0x0,0x1ec4(%esi)
    1515:	00 00 00 
    1518:	8d 65 f4             	lea    -0xc(%ebp),%esp
    151b:	5b                   	pop    %ebx
    151c:	5e                   	pop    %esi
    151d:	5f                   	pop    %edi
    151e:	5d                   	pop    %ebp
    151f:	c3                   	ret    
  if (tid < 0 || tid >= MAX_THREADS) return -1;
    1520:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    1525:	eb c1                	jmp    14e8 <thread_join+0x48>
...
void mutex_init(umutex_t *m) {
  ...
  m->locked = 0;
    ...
    1536:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    153c:	5d                   	pop    %ebp
    153d:	c3                   	ret    
...
void mutex_lock(umutex_t *m) {
    ...
    1547:	8b 5d 08             	mov    0x8(%ebp),%ebx
  while (m->locked) {
    154a:	8b 13                	mov    (%ebx),%edx
    154c:	85 d2                	test   %edx,%edx
    154e:	74 0b                	je     155b <mutex_lock+0x1b>
    thread_yield();
    1550:	e8 6b fe ff ff       	call   13c0 <thread_yield>
  while (m->locked) {
    1555:	8b 03                	mov    (%ebx),%eax
    1557:	85 c0                	test   %eax,%eax
    1559:	75 f5                	jne    1550 <mutex_lock+0x10>
  }
  m->locked = 1;
    155b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
}
...
00001570 <mutex_unlock>:
    1570:	55                   	push   %ebp
    1571:	89 e5                	mov    %esp,%ebp
    1573:	8b 45 08             	mov    0x8(%ebp),%eax
    1576:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    157c:	5d                   	pop    %ebp
    157d:	c3                   	ret    
...
uswtch:
movl 4(%esp), %eax
    157e:	8b 44 24 04          	mov    0x4(%esp),%eax
movl 8(%esp), %edx
    1582:	8b 54 24 08          	mov    0x8(%esp),%edx
pushl %ebp
    1586:	55                   	push   %ebp
pushl %ebx
    1587:	53                   	push   %ebx
...
pushl %edi
    1589:	57                   	push   %edi
movl %esp, (%eax)
    158a:	89 20                	mov    %esp,(%eax)
movl %edx, %esp
    158c:	89 d4                	mov    %edx,%esp
popl %edi
    158e:	5f                   	pop    %edi
popl %esi
    158f:	5e                   	pop    %esi
