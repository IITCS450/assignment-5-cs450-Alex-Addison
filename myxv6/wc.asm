  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  f4:	74 42                	je     138 <wc+0x98>
      if(buf[i] == '\n')
  f6:	0f be 87 20 10 00 00 	movsbl 0x1020(%edi),%eax
        l++;
 ...
 48c:	89 d1                	mov    %edx,%ecx
{
 ...
 4b9:	0f b6 92 dc 0b 00 00 	movzbl 0xbdc(%edx),%edx
 ...
 539:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5a9:	ff 24 85 84 0b 00 00 	jmp    *0xb84(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6b7:	90                   	nop
          s = "(null)";
 6b8:	ba 7b 0b 00 00       	mov    $0xb7b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d1:	a1 20 12 00 00       	mov    0x1220,%eax
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	89 15 20 12 00 00    	mov    %edx,0x1220
}
 718:	5e                   	pop    %esi
 719:	5f                   	pop    %edi
 71a:	5d                   	pop    %ebp
 ...
 749:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 74c:	89 15 20 12 00 00    	mov    %edx,0x1220
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 769:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 76c:	8b 3d 20 12 00 00    	mov    0x1220,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7af:	73 4f                	jae    800 <malloc+0xa0>
    ...
    if(p == freep)
 7b1:	8b 3d 20 12 00 00    	mov    0x1220,%edi
 ...
 7da:	e8 f1 fe ff ff       	call   6d0 <free>
  return freep;
 7df:	8b 15 20 12 00 00    	mov    0x1220,%edx
 ...
 80c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 80f:	89 15 20 12 00 00    	mov    %edx,0x1220
}
 ...
 81f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 20 12 00 00 24 	movl   $0x1224,0x1220
 827:	12 00 00 
    base.s.size = 0;
 82a:	bf 24 12 00 00       	mov    $0x1224,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 24 12 00 00 24 	movl   $0x1224,0x1224
 836:	12 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 83b:	c7 05 28 12 00 00 00 	movl   $0x0,0x1228
 842:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
 ...
 860:	c7 05 74 12 00 00 00 	movl   $0x0,0x1274
 867:	00 00 00 
 86a:	c7 05 84 12 00 00 00 	movl   $0x0,0x1284
 871:	00 00 00 
 874:	c7 05 94 12 00 00 00 	movl   $0x0,0x1294
 87b:	00 00 00 
 87e:	c7 05 a4 12 00 00 00 	movl   $0x0,0x12a4
 885:	00 00 00 
 888:	c7 05 b4 12 00 00 00 	movl   $0x0,0x12b4
 88f:	00 00 00 
 892:	c7 05 c4 12 00 00 00 	movl   $0x0,0x12c4
 899:	00 00 00 
 89c:	c7 05 d4 12 00 00 00 	movl   $0x0,0x12d4
 8a3:	00 00 00 
  }
  current_thread = &thread_table[0];
 8a6:	c7 05 40 12 00 00 60 	movl   $0x1260,0x1240
 8ad:	12 00 00 
  current_thread->state = RUNNING;
 8b0:	c7 05 64 12 00 00 02 	movl   $0x2,0x1264
 8b7:	00 00 00 
  current_thread->tid = 0;
 8ba:	c7 05 6c 12 00 00 00 	movl   $0x0,0x126c
 8c1:	00 00 00 
}
 8c4:	c3                   	ret    
 8c5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 8e0:	89 c3                	mov    %eax,%ebx
 8e2:	c1 e3 04             	shl    $0x4,%ebx
 8e5:	8b 93 64 12 00 00    	mov    0x1264(%ebx),%edx
 8eb:	85 d2                	test   %edx,%edx
 8ed:	74 19                	je     908 <thread_create+0x38>
  for (i = 0; i < MAX_THREADS; i++) {
 8ef:	83 c0 01             	add    $0x1,%eax
 8f2:	83 f8 08             	cmp    $0x8,%eax
 8f5:	75 e9                	jne    8e0 <thread_create+0x10>
 ...
 90b:	68 00 10 00 00       	push   $0x1000
 910:	e8 4b fe ff ff       	call   760 <malloc>
  sp -= 4; *(uint*)sp = (uint)arg;
 915:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  t->tid = (int)(t - thread_table);
 918:	83 c4 10             	add    $0x10,%esp
  t->state = RUNNABLE;
 91b:	c7 83 64 12 00 00 01 	movl   $0x1,0x1264(%ebx)
 922:	00 00 00 
  t->stack = malloc(STACK_SIZE);
 925:	89 83 60 12 00 00    	mov    %eax,0x1260(%ebx)
  sp -= 4; *(uint*)sp = (uint)arg;
 92b:	89 88 fc 0f 00 00    	mov    %ecx,0xffc(%eax)
  sp -= 4; *(uint*)sp = (uint)fn;
 931:	8b 4d 08             	mov    0x8(%ebp),%ecx
  sp -= 4; *(uint*)sp = 0;
 934:	c7 80 f4 0f 00 00 00 	movl   $0x0,0xff4(%eax)
 93b:	00 00 00 
  sp -= 4; *(uint*)sp = (uint)fn;
 93e:	89 88 f8 0f 00 00    	mov    %ecx,0xff8(%eax)
  sp -= sizeof(struct context);
 944:	8d 88 e0 0f 00 00    	lea    0xfe0(%eax),%ecx
  t->context->eip = (uint)thread_stub;
 94a:	c7 80 f0 0f 00 00 20 	movl   $0xa20,0xff0(%eax)
 951:	0a 00 00 
  t->tid = (int)(t - thread_table);
 954:	89 d8                	mov    %ebx,%eax
 956:	c1 f8 04             	sar    $0x4,%eax
  sp -= sizeof(struct context);
 959:	89 8b 68 12 00 00    	mov    %ecx,0x1268(%ebx)
  t->tid = (int)(t - thread_table);
 95f:	89 83 6c 12 00 00    	mov    %eax,0x126c(%ebx)
}
...
void thread_yield(void) {
 ...
 979:	8b 35 40 12 00 00    	mov    0x1240,%esi
  struct thread *next = 0;
  int i, idx;
  int start = (prev->tid + 1) % MAX_THREADS;
 97f:	8b 46 0c             	mov    0xc(%esi),%eax
 982:	83 c0 01             	add    $0x1,%eax
 985:	99                   	cltd   
 986:	c1 ea 1d             	shr    $0x1d,%edx
 989:	01 d0                	add    %edx,%eax
 98b:	83 e0 07             	and    $0x7,%eax
 98e:	29 d0                	sub    %edx,%eax
 990:	8d 58 08             	lea    0x8(%eax),%ebx
 ...
 99a:	c1 f9 1f             	sar    $0x1f,%ecx
 99d:	c1 e9 1d             	shr    $0x1d,%ecx
 9a0:	8d 14 08             	lea    (%eax,%ecx,1),%edx
 9a3:	83 e2 07             	and    $0x7,%edx
 9a6:	29 ca                	sub    %ecx,%edx
    if (thread_table[idx].state == RUNNABLE) {
 9a8:	89 d1                	mov    %edx,%ecx
 9aa:	c1 e1 04             	shl    $0x4,%ecx
 9ad:	83 b9 64 12 00 00 01 	cmpl   $0x1,0x1264(%ecx)
 9b4:	8d b9 60 12 00 00    	lea    0x1260(%ecx),%edi
 9ba:	74 14                	je     9d0 <thread_yield+0x60>
  for (i = 0; i < MAX_THREADS; i++) {
 9bc:	83 c0 01             	add    $0x1,%eax
 9bf:	39 c3                	cmp    %eax,%ebx
 9c1:	75 d5                	jne    998 <thread_yield+0x28>
 ...
 9cf:	90                   	nop
  if (next && next != prev) {
 9d0:	39 fe                	cmp    %edi,%esi
 9d2:	74 ef                	je     9c3 <thread_yield+0x53>
    if (prev->state == RUNNING) prev->state = RUNNABLE;
 9d4:	83 7e 04 02          	cmpl   $0x2,0x4(%esi)
 9d8:	74 36                	je     a10 <thread_yield+0xa0>
    uswtch(&prev->context, next->context);
 9da:	83 ec 08             	sub    $0x8,%esp
    next->state = RUNNING;
 9dd:	c1 e2 04             	shl    $0x4,%edx
    uswtch(&prev->context, next->context);
 9e0:	83 c6 08             	add    $0x8,%esi
    current_thread = next;
 9e3:	89 3d 40 12 00 00    	mov    %edi,0x1240
    uswtch(&prev->context, next->context);
 9e9:	ff b2 68 12 00 00    	pushl  0x1268(%edx)
 9ef:	56                   	push   %esi
    next->state = RUNNING;
 9f0:	c7 82 64 12 00 00 02 	movl   $0x2,0x1264(%edx)
 9f7:	00 00 00 
    uswtch(&prev->context, next->context);
 9fa:	e8 2f 01 00 00       	call   b2e <uswtch>
 9ff:	83 c4 10             	add    $0x10,%esp
}
 a02:	8d 65 f4             	lea    -0xc(%ebp),%esp
 a05:	5b                   	pop    %ebx
 a06:	5e                   	pop    %esi
 a07:	5f                   	pop    %edi
 a08:	5d                   	pop    %ebp
 ...
 a0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if (prev->state == RUNNING) prev->state = RUNNABLE;
 a10:	c7 46 04 01 00 00 00 	movl   $0x1,0x4(%esi)
 a17:	eb c1                	jmp    9da <thread_yield+0x6a>
 a19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00000a20 <thread_stub>:
void thread_stub(void (*fn)(void*), void *arg) {
 ...
 a29:	ff 55 08             	call   *0x8(%ebp)
  current_thread->state = ZOMBIE;
 a2c:	a1 40 12 00 00       	mov    0x1240,%eax
  thread_yield();
 a31:	83 c4 10             	add    $0x10,%esp
  current_thread->state = ZOMBIE;
 a34:	c7 40 04 03 00 00 00 	movl   $0x3,0x4(%eax)
}
 a3b:	c9                   	leave  
  thread_yield();
 a3c:	e9 2f ff ff ff       	jmp    970 <thread_yield>
 a41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 a48:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 a4f:	90                   	nop

00000a50 <thread_join>:
...
int thread_join(tid_t tid) {
 ...
 a5c:	83 fe 07             	cmp    $0x7,%esi
 a5f:	77 6f                	ja     ad0 <thread_join+0x80>

  while (thread_table[tid].state != ZOMBIE && thread_table[tid].state != UNUSED) {
 a61:	89 f3                	mov    %esi,%ebx
 a63:	c1 e3 04             	shl    $0x4,%ebx
 a66:	81 c3 60 12 00 00    	add    $0x1260,%ebx
 a6c:	8b 43 04             	mov    0x4(%ebx),%eax
 a6f:	83 f8 03             	cmp    $0x3,%eax
 a72:	75 19                	jne    a8d <thread_join+0x3d>
 a74:	eb 1b                	jmp    a91 <thread_join+0x41>
 a76:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 a7d:	8d 76 00             	lea    0x0(%esi),%esi
    thread_yield();
 a80:	e8 eb fe ff ff       	call   970 <thread_yield>
  while (thread_table[tid].state != ZOMBIE && thread_table[tid].state != UNUSED) {
 a85:	8b 43 04             	mov    0x4(%ebx),%eax
 a88:	83 f8 03             	cmp    $0x3,%eax
 a8b:	74 04                	je     a91 <thread_join+0x41>
 a8d:	85 c0                	test   %eax,%eax
 a8f:	75 ef                	jne    a80 <thread_join+0x30>
 ...
 a91:	31 db                	xor    %ebx,%ebx
  if (thread_table[tid].state == ZOMBIE) {
 a93:	83 f8 03             	cmp    $0x3,%eax
 a96:	74 10                	je     aa8 <thread_join+0x58>
 ...
 aa2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    free(thread_table[tid].stack);
 aa8:	c1 e6 04             	shl    $0x4,%esi
 aab:	83 ec 0c             	sub    $0xc,%esp
 aae:	ff b6 60 12 00 00    	pushl  0x1260(%esi)
 ab4:	e8 17 fc ff ff       	call   6d0 <free>
    thread_table[tid].state = UNUSED;
 ab9:	83 c4 10             	add    $0x10,%esp
 abc:	89 d8                	mov    %ebx,%eax
    thread_table[tid].state = UNUSED;
 abe:	c7 86 64 12 00 00 00 	movl   $0x0,0x1264(%esi)
 ac5:	00 00 00 
 ...
 acf:	c3                   	ret    
  if (tid < 0 || tid >= MAX_THREADS) return -1;
 ad0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
 ad5:	eb c1                	jmp    a98 <thread_join+0x48>
...
void mutex_lock(umutex_t *m) {
 ...
 af7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  while (m->locked) {
 afa:	8b 13                	mov    (%ebx),%edx
 afc:	85 d2                	test   %edx,%edx
 afe:	74 0b                	je     b0b <mutex_lock+0x1b>
    thread_yield();
 b00:	e8 6b fe ff ff       	call   970 <thread_yield>
  while (m->locked) {
 b05:	8b 03                	mov    (%ebx),%eax
 b07:	85 c0                	test   %eax,%eax
 b09:	75 f5                	jne    b00 <mutex_lock+0x10>
  }
  m->locked = 1;
 b0b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
}
...
uswtch:
movl 4(%esp), %eax
 b2e:	8b 44 24 04          	mov    0x4(%esp),%eax
movl 8(%esp), %edx
 b32:	8b 54 24 08          	mov    0x8(%esp),%edx
pushl %ebp
 b36:	55                   	push   %ebp
pushl %ebx
 b37:	53                   	push   %ebx
...
pushl %edi
 b39:	57                   	push   %edi
movl %esp, (%eax)
 b3a:	89 20                	mov    %esp,(%eax)
movl %edx, %esp
 b3c:	89 d4                	mov    %edx,%esp
popl %edi
 b3e:	5f                   	pop    %edi
popl %esi
 b3f:	5e                   	pop    %esi
