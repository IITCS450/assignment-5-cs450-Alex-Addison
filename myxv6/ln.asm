 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 ac 0a 00 00 	movzbl 0xaac(%edx),%edx
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 54 0a 00 00 	jmp    *0xa54(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 4b 0a 00 00       	mov    $0xa4b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 a0 0e 00 00       	mov    0xea0,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 a0 0e 00 00    	mov    %edx,0xea0
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 a0 0e 00 00    	mov    %edx,0xea0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d a0 0e 00 00    	mov    0xea0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d a0 0e 00 00    	mov    0xea0,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 a0 0e 00 00    	mov    0xea0,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 a0 0e 00 00    	mov    %edx,0xea0
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 a0 0e 00 00 a4 	movl   $0xea4,0xea0
 707:	0e 00 00 
    base.s.size = 0;
 70a:	bf a4 0e 00 00       	mov    $0xea4,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 a4 0e 00 00 a4 	movl   $0xea4,0xea4
 716:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 a8 0e 00 00 00 	movl   $0x0,0xea8
 722:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
 ...
 740:	c7 05 f4 0e 00 00 00 	movl   $0x0,0xef4
 747:	00 00 00 
 74a:	c7 05 04 0f 00 00 00 	movl   $0x0,0xf04
 751:	00 00 00 
 754:	c7 05 14 0f 00 00 00 	movl   $0x0,0xf14
 75b:	00 00 00 
 75e:	c7 05 24 0f 00 00 00 	movl   $0x0,0xf24
 765:	00 00 00 
 768:	c7 05 34 0f 00 00 00 	movl   $0x0,0xf34
 76f:	00 00 00 
 772:	c7 05 44 0f 00 00 00 	movl   $0x0,0xf44
 779:	00 00 00 
 77c:	c7 05 54 0f 00 00 00 	movl   $0x0,0xf54
 783:	00 00 00 
  }
  current_thread = &thread_table[0];
 786:	c7 05 c0 0e 00 00 e0 	movl   $0xee0,0xec0
 78d:	0e 00 00 
  current_thread->state = RUNNING;
 790:	c7 05 e4 0e 00 00 02 	movl   $0x2,0xee4
 797:	00 00 00 
  current_thread->tid = 0;
 79a:	c7 05 ec 0e 00 00 00 	movl   $0x0,0xeec
 7a1:	00 00 00 
}
 7a4:	c3                   	ret    
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 7c2:	c1 e3 04             	shl    $0x4,%ebx
 7c5:	8b 93 e4 0e 00 00    	mov    0xee4(%ebx),%edx
 7cb:	85 d2                	test   %edx,%edx
 7cd:	74 19                	je     7e8 <thread_create+0x38>
  for (i = 0; i < MAX_THREADS; i++) {
 7cf:	83 c0 01             	add    $0x1,%eax
 7d2:	83 f8 08             	cmp    $0x8,%eax
 7d5:	75 e9                	jne    7c0 <thread_create+0x10>
 ...
 7d7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  if (!t) return -1;
 7da:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 7df:	c9                   	leave  
 7e0:	c3                   	ret    
 ...
 7eb:	68 00 10 00 00       	push   $0x1000
 7f0:	e8 4b fe ff ff       	call   640 <malloc>
  sp -= 4; *(uint*)sp = (uint)arg;
 7f5:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  t->tid = (int)(t - thread_table);
 7f8:	83 c4 10             	add    $0x10,%esp
  t->state = RUNNABLE;
 7fb:	c7 83 e4 0e 00 00 01 	movl   $0x1,0xee4(%ebx)
 802:	00 00 00 
  t->stack = malloc(STACK_SIZE);
 805:	89 83 e0 0e 00 00    	mov    %eax,0xee0(%ebx)
  sp -= 4; *(uint*)sp = (uint)arg;
 80b:	89 88 fc 0f 00 00    	mov    %ecx,0xffc(%eax)
  sp -= 4; *(uint*)sp = (uint)fn;
 811:	8b 4d 08             	mov    0x8(%ebp),%ecx
  sp -= 4; *(uint*)sp = 0;
 814:	c7 80 f4 0f 00 00 00 	movl   $0x0,0xff4(%eax)
 81b:	00 00 00 
  sp -= 4; *(uint*)sp = (uint)fn;
 81e:	89 88 f8 0f 00 00    	mov    %ecx,0xff8(%eax)
  sp -= sizeof(struct context);
 824:	8d 88 e0 0f 00 00    	lea    0xfe0(%eax),%ecx
  t->context->eip = (uint)thread_stub;
 82a:	c7 80 f0 0f 00 00 00 	movl   $0x900,0xff0(%eax)
 831:	09 00 00 
  t->tid = (int)(t - thread_table);
 834:	89 d8                	mov    %ebx,%eax
 836:	c1 f8 04             	sar    $0x4,%eax
  sp -= sizeof(struct context);
 839:	89 8b e8 0e 00 00    	mov    %ecx,0xee8(%ebx)
  t->tid = (int)(t - thread_table);
 83f:	89 83 ec 0e 00 00    	mov    %eax,0xeec(%ebx)
}
...
void thread_yield(void) {
 ...
 859:	8b 35 c0 0e 00 00    	mov    0xec0,%esi
  struct thread *next = 0;
  int i, idx;
  int start = (prev->tid + 1) % MAX_THREADS;
 85f:	8b 46 0c             	mov    0xc(%esi),%eax
 862:	83 c0 01             	add    $0x1,%eax
 865:	99                   	cltd   
 866:	c1 ea 1d             	shr    $0x1d,%edx
 869:	01 d0                	add    %edx,%eax
 86b:	83 e0 07             	and    $0x7,%eax
 86e:	29 d0                	sub    %edx,%eax
 870:	8d 58 08             	lea    0x8(%eax),%ebx
 ...
 87a:	c1 f9 1f             	sar    $0x1f,%ecx
 87d:	c1 e9 1d             	shr    $0x1d,%ecx
 880:	8d 14 08             	lea    (%eax,%ecx,1),%edx
 883:	83 e2 07             	and    $0x7,%edx
 886:	29 ca                	sub    %ecx,%edx
    if (thread_table[idx].state == RUNNABLE) {
 888:	89 d1                	mov    %edx,%ecx
 88a:	c1 e1 04             	shl    $0x4,%ecx
 88d:	83 b9 e4 0e 00 00 01 	cmpl   $0x1,0xee4(%ecx)
 894:	8d b9 e0 0e 00 00    	lea    0xee0(%ecx),%edi
 89a:	74 14                	je     8b0 <thread_yield+0x60>
  for (i = 0; i < MAX_THREADS; i++) {
 89c:	83 c0 01             	add    $0x1,%eax
 89f:	39 c3                	cmp    %eax,%ebx
 8a1:	75 d5                	jne    878 <thread_yield+0x28>
 ...
 8af:	90                   	nop
  if (next && next != prev) {
 8b0:	39 fe                	cmp    %edi,%esi
 8b2:	74 ef                	je     8a3 <thread_yield+0x53>
    if (prev->state == RUNNING) prev->state = RUNNABLE;
 8b4:	83 7e 04 02          	cmpl   $0x2,0x4(%esi)
 8b8:	74 36                	je     8f0 <thread_yield+0xa0>
    uswtch(&prev->context, next->context);
 8ba:	83 ec 08             	sub    $0x8,%esp
    next->state = RUNNING;
 8bd:	c1 e2 04             	shl    $0x4,%edx
    uswtch(&prev->context, next->context);
 8c0:	83 c6 08             	add    $0x8,%esi
    current_thread = next;
 8c3:	89 3d c0 0e 00 00    	mov    %edi,0xec0
    uswtch(&prev->context, next->context);
 8c9:	ff b2 e8 0e 00 00    	pushl  0xee8(%edx)
 8cf:	56                   	push   %esi
    next->state = RUNNING;
 8d0:	c7 82 e4 0e 00 00 02 	movl   $0x2,0xee4(%edx)
 8d7:	00 00 00 
    uswtch(&prev->context, next->context);
 8da:	e8 2f 01 00 00       	call   a0e <uswtch>
 ...
 8ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if (prev->state == RUNNING) prev->state = RUNNABLE;
 8f0:	c7 46 04 01 00 00 00 	movl   $0x1,0x4(%esi)
 8f7:	eb c1                	jmp    8ba <thread_yield+0x6a>
 8f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00000900 <thread_stub>:
void thread_stub(void (*fn)(void*), void *arg) {
 900:	55                   	push   %ebp
 901:	89 e5                	mov    %esp,%ebp
 903:	83 ec 14             	sub    $0x14,%esp
  fn(arg);
 906:	ff 75 0c             	pushl  0xc(%ebp)
 909:	ff 55 08             	call   *0x8(%ebp)
  current_thread->state = ZOMBIE;
 90c:	a1 c0 0e 00 00       	mov    0xec0,%eax
  thread_yield();
 911:	83 c4 10             	add    $0x10,%esp
  current_thread->state = ZOMBIE;
 914:	c7 40 04 03 00 00 00 	movl   $0x3,0x4(%eax)
}
 91b:	c9                   	leave  
  thread_yield();
 91c:	e9 2f ff ff ff       	jmp    850 <thread_yield>
 921:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 928:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 92f:	90                   	nop

00000930 <thread_join>:
...
int thread_join(tid_t tid) {
 ...
 93c:	83 fe 07             	cmp    $0x7,%esi
 93f:	77 6f                	ja     9b0 <thread_join+0x80>

  while (thread_table[tid].state != ZOMBIE && thread_table[tid].state != UNUSED) {
 941:	89 f3                	mov    %esi,%ebx
 943:	c1 e3 04             	shl    $0x4,%ebx
 946:	81 c3 e0 0e 00 00    	add    $0xee0,%ebx
 94c:	8b 43 04             	mov    0x4(%ebx),%eax
 94f:	83 f8 03             	cmp    $0x3,%eax
 952:	75 19                	jne    96d <thread_join+0x3d>
 954:	eb 1b                	jmp    971 <thread_join+0x41>
 956:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 95d:	8d 76 00             	lea    0x0(%esi),%esi
    thread_yield();
 960:	e8 eb fe ff ff       	call   850 <thread_yield>
  while (thread_table[tid].state != ZOMBIE && thread_table[tid].state != UNUSED) {
 965:	8b 43 04             	mov    0x4(%ebx),%eax
 968:	83 f8 03             	cmp    $0x3,%eax
 96b:	74 04                	je     971 <thread_join+0x41>
 96d:	85 c0                	test   %eax,%eax
 96f:	75 ef                	jne    960 <thread_join+0x30>
 ...
 971:	31 db                	xor    %ebx,%ebx
  if (thread_table[tid].state == ZOMBIE) {
 973:	83 f8 03             	cmp    $0x3,%eax
 976:	74 10                	je     988 <thread_join+0x58>
 ...
 982:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    free(thread_table[tid].stack);
 988:	c1 e6 04             	shl    $0x4,%esi
 98b:	83 ec 0c             	sub    $0xc,%esp
 98e:	ff b6 e0 0e 00 00    	pushl  0xee0(%esi)
 994:	e8 17 fc ff ff       	call   5b0 <free>
    thread_table[tid].state = UNUSED;
 999:	83 c4 10             	add    $0x10,%esp
 99c:	89 d8                	mov    %ebx,%eax
    thread_table[tid].state = UNUSED;
 99e:	c7 86 e4 0e 00 00 00 	movl   $0x0,0xee4(%esi)
 9a5:	00 00 00 
 ...
 9af:	c3                   	ret    
  if (tid < 0 || tid >= MAX_THREADS) return -1;
 9b0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
 9b5:	eb c1                	jmp    978 <thread_join+0x48>
...
void mutex_lock(umutex_t *m) {
 ...
 9d7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  while (m->locked) {
 9da:	8b 13                	mov    (%ebx),%edx
 9dc:	85 d2                	test   %edx,%edx
 9de:	74 0b                	je     9eb <mutex_lock+0x1b>
    thread_yield();
 9e0:	e8 6b fe ff ff       	call   850 <thread_yield>
  while (m->locked) {
 9e5:	8b 03                	mov    (%ebx),%eax
 9e7:	85 c0                	test   %eax,%eax
 9e9:	75 f5                	jne    9e0 <mutex_lock+0x10>
  }
  m->locked = 1;
 9eb:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
}
...
uswtch:
movl 4(%esp), %eax
 a0e:	8b 44 24 04          	mov    0x4(%esp),%eax
movl 8(%esp), %edx
 a12:	8b 54 24 08          	mov    0x8(%esp),%edx
pushl %ebp
 a16:	55                   	push   %ebp
pushl %ebx
 a17:	53                   	push   %ebx
...
pushl %edi
 a19:	57                   	push   %edi
movl %esp, (%eax)
 a1a:	89 20                	mov    %esp,(%eax)
movl %edx, %esp
 a1c:	89 d4                	mov    %edx,%esp
popl %edi
 a1e:	5f                   	pop    %edi
popl %esi
 a1f:	5e                   	pop    %esi
