...
00000060 <fmtname>:
{
  ...
  return buf;
  c5:	bb 40 12 00 00       	mov    $0x1240,%ebx
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
  ...
  db:	05 40 12 00 00       	add    $0x1240,%eax
  e0:	52                   	push   %edx
  e1:	6a 20                	push   $0x20
  e3:	50                   	push   %eax
 ...
 64c:	89 d1                	mov    %edx,%ecx
{
 ...
 679:	0f b6 92 b0 0d 00 00 	movzbl 0xdb0(%edx),%edx
 ...
 6f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 769:	ff 24 85 58 0d 00 00 	jmp    *0xd58(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 877:	90                   	nop
          s = "(null)";
 878:	ba 4e 0d 00 00       	mov    $0xd4e,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 891:	a1 50 12 00 00       	mov    0x1250,%eax
{
 ...
 8d1:	5b                   	pop    %ebx
  freep = p;
 8d2:	89 15 50 12 00 00    	mov    %edx,0x1250
}
 8d8:	5e                   	pop    %esi
 8d9:	5f                   	pop    %edi
 8da:	5d                   	pop    %ebp
 ...
 909:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 90c:	89 15 50 12 00 00    	mov    %edx,0x1250
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 929:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 92c:	8b 3d 50 12 00 00    	mov    0x1250,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 96f:	73 4f                	jae    9c0 <malloc+0xa0>
    ...
    if(p == freep)
 971:	8b 3d 50 12 00 00    	mov    0x1250,%edi
 ...
 99a:	e8 f1 fe ff ff       	call   890 <free>
  return freep;
 99f:	8b 15 50 12 00 00    	mov    0x1250,%edx
 ...
 9cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 9cf:	89 15 50 12 00 00    	mov    %edx,0x1250
}
 ...
 9df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 9e0:	c7 05 50 12 00 00 54 	movl   $0x1254,0x1250
 9e7:	12 00 00 
    base.s.size = 0;
 9ea:	bf 54 12 00 00       	mov    $0x1254,%edi
    base.s.ptr = freep = prevp = &base;
 9ef:	c7 05 54 12 00 00 54 	movl   $0x1254,0x1254
 9f6:	12 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 9f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 9fb:	c7 05 58 12 00 00 00 	movl   $0x0,0x1258
 a02:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
 ...
 a20:	c7 05 94 12 00 00 00 	movl   $0x0,0x1294
 a27:	00 00 00 
 a2a:	c7 05 a4 12 00 00 00 	movl   $0x0,0x12a4
 a31:	00 00 00 
 a34:	c7 05 b4 12 00 00 00 	movl   $0x0,0x12b4
 a3b:	00 00 00 
 a3e:	c7 05 c4 12 00 00 00 	movl   $0x0,0x12c4
 a45:	00 00 00 
 a48:	c7 05 d4 12 00 00 00 	movl   $0x0,0x12d4
 a4f:	00 00 00 
 a52:	c7 05 e4 12 00 00 00 	movl   $0x0,0x12e4
 a59:	00 00 00 
 a5c:	c7 05 f4 12 00 00 00 	movl   $0x0,0x12f4
 a63:	00 00 00 
  }
  current_thread = &thread_table[0];
 a66:	c7 05 60 12 00 00 80 	movl   $0x1280,0x1260
 a6d:	12 00 00 
  current_thread->state = RUNNING;
 a70:	c7 05 84 12 00 00 02 	movl   $0x2,0x1284
 a77:	00 00 00 
  current_thread->tid = 0;
 a7a:	c7 05 8c 12 00 00 00 	movl   $0x0,0x128c
 a81:	00 00 00 
}
 a84:	c3                   	ret    
 a85:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 a8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

00000a90 <thread_create>:
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 aa0:	89 c3                	mov    %eax,%ebx
 aa2:	c1 e3 04             	shl    $0x4,%ebx
 aa5:	8b 93 84 12 00 00    	mov    0x1284(%ebx),%edx
 aab:	85 d2                	test   %edx,%edx
 aad:	74 19                	je     ac8 <thread_create+0x38>
  for (i = 0; i < MAX_THREADS; i++) {
 aaf:	83 c0 01             	add    $0x1,%eax
 ab2:	83 f8 08             	cmp    $0x8,%eax
 ab5:	75 e9                	jne    aa0 <thread_create+0x10>
 ...
 acb:	68 00 10 00 00       	push   $0x1000
 ad0:	e8 4b fe ff ff       	call   920 <malloc>
  sp -= 4; *(uint*)sp = (uint)arg;
 ad5:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  t->tid = (int)(t - thread_table);
 ad8:	83 c4 10             	add    $0x10,%esp
  t->state = RUNNABLE;
 adb:	c7 83 84 12 00 00 01 	movl   $0x1,0x1284(%ebx)
 ae2:	00 00 00 
  t->stack = malloc(STACK_SIZE);
 ae5:	89 83 80 12 00 00    	mov    %eax,0x1280(%ebx)
  sp -= 4; *(uint*)sp = (uint)arg;
 aeb:	89 88 fc 0f 00 00    	mov    %ecx,0xffc(%eax)
  sp -= 4; *(uint*)sp = (uint)fn;
 af1:	8b 4d 08             	mov    0x8(%ebp),%ecx
  sp -= 4; *(uint*)sp = 0;
 af4:	c7 80 f4 0f 00 00 00 	movl   $0x0,0xff4(%eax)
 afb:	00 00 00 
  sp -= 4; *(uint*)sp = (uint)fn;
 afe:	89 88 f8 0f 00 00    	mov    %ecx,0xff8(%eax)
  sp -= sizeof(struct context);
 b04:	8d 88 e0 0f 00 00    	lea    0xfe0(%eax),%ecx
  t->context->eip = (uint)thread_stub;
 b0a:	c7 80 f0 0f 00 00 e0 	movl   $0xbe0,0xff0(%eax)
 b11:	0b 00 00 
  t->tid = (int)(t - thread_table);
 b14:	89 d8                	mov    %ebx,%eax
 b16:	c1 f8 04             	sar    $0x4,%eax
  sp -= sizeof(struct context);
 b19:	89 8b 88 12 00 00    	mov    %ecx,0x1288(%ebx)
  t->tid = (int)(t - thread_table);
 b1f:	89 83 8c 12 00 00    	mov    %eax,0x128c(%ebx)
}
...
void thread_yield(void) {
 ...
 b39:	8b 35 60 12 00 00    	mov    0x1260,%esi
  struct thread *next = 0;
  int i, idx;
  int start = (prev->tid + 1) % MAX_THREADS;
 b3f:	8b 46 0c             	mov    0xc(%esi),%eax
 b42:	83 c0 01             	add    $0x1,%eax
 b45:	99                   	cltd   
 b46:	c1 ea 1d             	shr    $0x1d,%edx
 b49:	01 d0                	add    %edx,%eax
 b4b:	83 e0 07             	and    $0x7,%eax
 b4e:	29 d0                	sub    %edx,%eax
 b50:	8d 58 08             	lea    0x8(%eax),%ebx
 b53:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 b57:	90                   	nop

  for (i = 0; i < MAX_THREADS; i++) {
    idx = (start + i) % MAX_THREADS;
 b58:	89 c1                	mov    %eax,%ecx
 b5a:	c1 f9 1f             	sar    $0x1f,%ecx
 b5d:	c1 e9 1d             	shr    $0x1d,%ecx
 b60:	8d 14 08             	lea    (%eax,%ecx,1),%edx
 b63:	83 e2 07             	and    $0x7,%edx
 b66:	29 ca                	sub    %ecx,%edx
    if (thread_table[idx].state == RUNNABLE) {
 b68:	89 d1                	mov    %edx,%ecx
 b6a:	c1 e1 04             	shl    $0x4,%ecx
 b6d:	83 b9 84 12 00 00 01 	cmpl   $0x1,0x1284(%ecx)
 b74:	8d b9 80 12 00 00    	lea    0x1280(%ecx),%edi
 b7a:	74 14                	je     b90 <thread_yield+0x60>
  for (i = 0; i < MAX_THREADS; i++) {
 b7c:	83 c0 01             	add    $0x1,%eax
 b7f:	39 c3                	cmp    %eax,%ebx
 b81:	75 d5                	jne    b58 <thread_yield+0x28>
 ...
 b8f:	90                   	nop
  if (next && next != prev) {
 b90:	39 fe                	cmp    %edi,%esi
 b92:	74 ef                	je     b83 <thread_yield+0x53>
    if (prev->state == RUNNING) prev->state = RUNNABLE;
 b94:	83 7e 04 02          	cmpl   $0x2,0x4(%esi)
 b98:	74 36                	je     bd0 <thread_yield+0xa0>
    uswtch(&prev->context, next->context);
 b9a:	83 ec 08             	sub    $0x8,%esp
    next->state = RUNNING;
 b9d:	c1 e2 04             	shl    $0x4,%edx
    uswtch(&prev->context, next->context);
 ba0:	83 c6 08             	add    $0x8,%esi
    current_thread = next;
 ba3:	89 3d 60 12 00 00    	mov    %edi,0x1260
    uswtch(&prev->context, next->context);
 ba9:	ff b2 88 12 00 00    	pushl  0x1288(%edx)
 baf:	56                   	push   %esi
    next->state = RUNNING;
 bb0:	c7 82 84 12 00 00 02 	movl   $0x2,0x1284(%edx)
 bb7:	00 00 00 
    uswtch(&prev->context, next->context);
 bba:	e8 2f 01 00 00       	call   cee <uswtch>
 ...
 bca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if (prev->state == RUNNING) prev->state = RUNNABLE;
 bd0:	c7 46 04 01 00 00 00 	movl   $0x1,0x4(%esi)
 bd7:	eb c1                	jmp    b9a <thread_yield+0x6a>
 bd9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00000be0 <thread_stub>:
void thread_stub(void (*fn)(void*), void *arg) {
 be0:	55                   	push   %ebp
 be1:	89 e5                	mov    %esp,%ebp
 be3:	83 ec 14             	sub    $0x14,%esp
  fn(arg);
 be6:	ff 75 0c             	pushl  0xc(%ebp)
 be9:	ff 55 08             	call   *0x8(%ebp)
  current_thread->state = ZOMBIE;
 bec:	a1 60 12 00 00       	mov    0x1260,%eax
  thread_yield();
 bf1:	83 c4 10             	add    $0x10,%esp
  current_thread->state = ZOMBIE;
 bf4:	c7 40 04 03 00 00 00 	movl   $0x3,0x4(%eax)
}
 bfb:	c9                   	leave  
  thread_yield();
 bfc:	e9 2f ff ff ff       	jmp    b30 <thread_yield>
 c01:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 c08:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 c0f:	90                   	nop

00000c10 <thread_join>:
...
int thread_join(tid_t tid) {
 ...
 c1c:	83 fe 07             	cmp    $0x7,%esi
 c1f:	77 6f                	ja     c90 <thread_join+0x80>

  while (thread_table[tid].state != ZOMBIE && thread_table[tid].state != UNUSED) {
 c21:	89 f3                	mov    %esi,%ebx
 c23:	c1 e3 04             	shl    $0x4,%ebx
 c26:	81 c3 80 12 00 00    	add    $0x1280,%ebx
 c2c:	8b 43 04             	mov    0x4(%ebx),%eax
 c2f:	83 f8 03             	cmp    $0x3,%eax
 c32:	75 19                	jne    c4d <thread_join+0x3d>
 c34:	eb 1b                	jmp    c51 <thread_join+0x41>
 c36:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 c3d:	8d 76 00             	lea    0x0(%esi),%esi
    thread_yield();
 c40:	e8 eb fe ff ff       	call   b30 <thread_yield>
  while (thread_table[tid].state != ZOMBIE && thread_table[tid].state != UNUSED) {
 c45:	8b 43 04             	mov    0x4(%ebx),%eax
 c48:	83 f8 03             	cmp    $0x3,%eax
 c4b:	74 04                	je     c51 <thread_join+0x41>
 c4d:	85 c0                	test   %eax,%eax
 c4f:	75 ef                	jne    c40 <thread_join+0x30>
  ...
  return 0;
 c51:	31 db                	xor    %ebx,%ebx
  if (thread_table[tid].state == ZOMBIE) {
 c53:	83 f8 03             	cmp    $0x3,%eax
 c56:	74 10                	je     c68 <thread_join+0x58>
 ...
 c62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    free(thread_table[tid].stack);
 c68:	c1 e6 04             	shl    $0x4,%esi
 c6b:	83 ec 0c             	sub    $0xc,%esp
 c6e:	ff b6 80 12 00 00    	pushl  0x1280(%esi)
 c74:	e8 17 fc ff ff       	call   890 <free>
    thread_table[tid].state = UNUSED;
 c79:	83 c4 10             	add    $0x10,%esp
 c7c:	89 d8                	mov    %ebx,%eax
    thread_table[tid].state = UNUSED;
 c7e:	c7 86 84 12 00 00 00 	movl   $0x0,0x1284(%esi)
 c85:	00 00 00 
 ...
 c8f:	c3                   	ret    
  if (tid < 0 || tid >= MAX_THREADS) return -1;
 c90:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
 c95:	eb c1                	jmp    c58 <thread_join+0x48>
...
void mutex_init(umutex_t *m) {
 ...
 ca6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 cac:	5d                   	pop    %ebp
 cad:	c3                   	ret    
...
void mutex_lock(umutex_t *m) {
 ...
 cbe:	74 0b                	je     ccb <mutex_lock+0x1b>
    thread_yield();
 cc0:	e8 6b fe ff ff       	call   b30 <thread_yield>
  while (m->locked) {
 cc5:	8b 03                	mov    (%ebx),%eax
 cc7:	85 c0                	test   %eax,%eax
 cc9:	75 f5                	jne    cc0 <mutex_lock+0x10>
  }
  m->locked = 1;
 ccb:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
}
...
uswtch:
movl 4(%esp), %eax
 cee:	8b 44 24 04          	mov    0x4(%esp),%eax
movl 8(%esp), %edx
 cf2:	8b 54 24 08          	mov    0x8(%esp),%edx
pushl %ebp
 cf6:	55                   	push   %ebp
pushl %ebx
 cf7:	53                   	push   %ebx
...
pushl %edi
 cf9:	57                   	push   %edi
movl %esp, (%eax)
 cfa:	89 20                	mov    %esp,(%eax)
movl %edx, %esp
 cfc:	89 d4                	mov    %edx,%esp
popl %edi
 cfe:	5f                   	pop    %edi
popl %esi
 cff:	5e                   	pop    %esi
