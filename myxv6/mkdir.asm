 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 d8 0a 00 00 	movzbl 0xad8(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 80 0a 00 00 	jmp    *0xa80(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 77 0a 00 00       	mov    $0xa77,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 e0 0e 00 00       	mov    0xee0,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 e0 0e 00 00    	mov    %edx,0xee0
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 e0 0e 00 00    	mov    %edx,0xee0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d e0 0e 00 00    	mov    0xee0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d e0 0e 00 00    	mov    0xee0,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 e0 0e 00 00    	mov    0xee0,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 e0 0e 00 00    	mov    %edx,0xee0
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 e0 0e 00 00 e4 	movl   $0xee4,0xee0
 727:	0e 00 00 
    base.s.size = 0;
 72a:	bf e4 0e 00 00       	mov    $0xee4,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 e4 0e 00 00 e4 	movl   $0xee4,0xee4
 736:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 e8 0e 00 00 00 	movl   $0x0,0xee8
 742:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
 ...
 760:	c7 05 34 0f 00 00 00 	movl   $0x0,0xf34
 767:	00 00 00 
 76a:	c7 05 44 0f 00 00 00 	movl   $0x0,0xf44
 771:	00 00 00 
 774:	c7 05 54 0f 00 00 00 	movl   $0x0,0xf54
 77b:	00 00 00 
 77e:	c7 05 64 0f 00 00 00 	movl   $0x0,0xf64
 785:	00 00 00 
 788:	c7 05 74 0f 00 00 00 	movl   $0x0,0xf74
 78f:	00 00 00 
 792:	c7 05 84 0f 00 00 00 	movl   $0x0,0xf84
 799:	00 00 00 
 79c:	c7 05 94 0f 00 00 00 	movl   $0x0,0xf94
 7a3:	00 00 00 
  }
  current_thread = &thread_table[0];
 7a6:	c7 05 00 0f 00 00 20 	movl   $0xf20,0xf00
 7ad:	0f 00 00 
  current_thread->state = RUNNING;
 7b0:	c7 05 24 0f 00 00 02 	movl   $0x2,0xf24
 7b7:	00 00 00 
  current_thread->tid = 0;
 7ba:	c7 05 2c 0f 00 00 00 	movl   $0x0,0xf2c
 7c1:	00 00 00 
}
 7c4:	c3                   	ret    
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 7e2:	c1 e3 04             	shl    $0x4,%ebx
 7e5:	8b 93 24 0f 00 00    	mov    0xf24(%ebx),%edx
 7eb:	85 d2                	test   %edx,%edx
 7ed:	74 19                	je     808 <thread_create+0x38>
  for (i = 0; i < MAX_THREADS; i++) {
 7ef:	83 c0 01             	add    $0x1,%eax
 7f2:	83 f8 08             	cmp    $0x8,%eax
 7f5:	75 e9                	jne    7e0 <thread_create+0x10>
 ...
 80b:	68 00 10 00 00       	push   $0x1000
 810:	e8 4b fe ff ff       	call   660 <malloc>
  sp -= 4; *(uint*)sp = (uint)arg;
 815:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  t->tid = (int)(t - thread_table);
 818:	83 c4 10             	add    $0x10,%esp
  t->state = RUNNABLE;
 81b:	c7 83 24 0f 00 00 01 	movl   $0x1,0xf24(%ebx)
 822:	00 00 00 
  t->stack = malloc(STACK_SIZE);
 825:	89 83 20 0f 00 00    	mov    %eax,0xf20(%ebx)
  sp -= 4; *(uint*)sp = (uint)arg;
 82b:	89 88 fc 0f 00 00    	mov    %ecx,0xffc(%eax)
  sp -= 4; *(uint*)sp = (uint)fn;
 831:	8b 4d 08             	mov    0x8(%ebp),%ecx
  sp -= 4; *(uint*)sp = 0;
 834:	c7 80 f4 0f 00 00 00 	movl   $0x0,0xff4(%eax)
 83b:	00 00 00 
  sp -= 4; *(uint*)sp = (uint)fn;
 83e:	89 88 f8 0f 00 00    	mov    %ecx,0xff8(%eax)
  sp -= sizeof(struct context);
 844:	8d 88 e0 0f 00 00    	lea    0xfe0(%eax),%ecx
  t->context->eip = (uint)thread_stub;
 84a:	c7 80 f0 0f 00 00 20 	movl   $0x920,0xff0(%eax)
 851:	09 00 00 
  t->tid = (int)(t - thread_table);
 854:	89 d8                	mov    %ebx,%eax
 856:	c1 f8 04             	sar    $0x4,%eax
  sp -= sizeof(struct context);
 859:	89 8b 28 0f 00 00    	mov    %ecx,0xf28(%ebx)
  t->tid = (int)(t - thread_table);
 85f:	89 83 2c 0f 00 00    	mov    %eax,0xf2c(%ebx)
}
 865:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 868:	c9                   	leave  
 869:	c3                   	ret    
 86a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

00000870 <thread_yield>:
...
void thread_yield(void) {
 ...
 879:	8b 35 00 0f 00 00    	mov    0xf00,%esi
  struct thread *next = 0;
  int i, idx;
  int start = (prev->tid + 1) % MAX_THREADS;
 87f:	8b 46 0c             	mov    0xc(%esi),%eax
 882:	83 c0 01             	add    $0x1,%eax
 885:	99                   	cltd   
 886:	c1 ea 1d             	shr    $0x1d,%edx
 889:	01 d0                	add    %edx,%eax
 88b:	83 e0 07             	and    $0x7,%eax
 88e:	29 d0                	sub    %edx,%eax
 890:	8d 58 08             	lea    0x8(%eax),%ebx
 ...
 89a:	c1 f9 1f             	sar    $0x1f,%ecx
 89d:	c1 e9 1d             	shr    $0x1d,%ecx
 8a0:	8d 14 08             	lea    (%eax,%ecx,1),%edx
 8a3:	83 e2 07             	and    $0x7,%edx
 8a6:	29 ca                	sub    %ecx,%edx
    if (thread_table[idx].state == RUNNABLE) {
 8a8:	89 d1                	mov    %edx,%ecx
 8aa:	c1 e1 04             	shl    $0x4,%ecx
 8ad:	83 b9 24 0f 00 00 01 	cmpl   $0x1,0xf24(%ecx)
 8b4:	8d b9 20 0f 00 00    	lea    0xf20(%ecx),%edi
 8ba:	74 14                	je     8d0 <thread_yield+0x60>
  for (i = 0; i < MAX_THREADS; i++) {
 8bc:	83 c0 01             	add    $0x1,%eax
 8bf:	39 c3                	cmp    %eax,%ebx
 8c1:	75 d5                	jne    898 <thread_yield+0x28>
 ...
 8cf:	90                   	nop
  if (next && next != prev) {
 8d0:	39 fe                	cmp    %edi,%esi
 8d2:	74 ef                	je     8c3 <thread_yield+0x53>
    if (prev->state == RUNNING) prev->state = RUNNABLE;
 8d4:	83 7e 04 02          	cmpl   $0x2,0x4(%esi)
 8d8:	74 36                	je     910 <thread_yield+0xa0>
    uswtch(&prev->context, next->context);
 8da:	83 ec 08             	sub    $0x8,%esp
    next->state = RUNNING;
 8dd:	c1 e2 04             	shl    $0x4,%edx
    uswtch(&prev->context, next->context);
 8e0:	83 c6 08             	add    $0x8,%esi
    current_thread = next;
 8e3:	89 3d 00 0f 00 00    	mov    %edi,0xf00
    uswtch(&prev->context, next->context);
 8e9:	ff b2 28 0f 00 00    	pushl  0xf28(%edx)
 8ef:	56                   	push   %esi
    next->state = RUNNING;
 8f0:	c7 82 24 0f 00 00 02 	movl   $0x2,0xf24(%edx)
 8f7:	00 00 00 
    uswtch(&prev->context, next->context);
 8fa:	e8 2f 01 00 00       	call   a2e <uswtch>
 8ff:	83 c4 10             	add    $0x10,%esp
}
 902:	8d 65 f4             	lea    -0xc(%ebp),%esp
 905:	5b                   	pop    %ebx
 906:	5e                   	pop    %esi
 907:	5f                   	pop    %edi
 908:	5d                   	pop    %ebp
 ...
 90a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if (prev->state == RUNNING) prev->state = RUNNABLE;
 910:	c7 46 04 01 00 00 00 	movl   $0x1,0x4(%esi)
 917:	eb c1                	jmp    8da <thread_yield+0x6a>
 919:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00000920 <thread_stub>:
void thread_stub(void (*fn)(void*), void *arg) {
 920:	55                   	push   %ebp
 921:	89 e5                	mov    %esp,%ebp
 923:	83 ec 14             	sub    $0x14,%esp
  fn(arg);
 926:	ff 75 0c             	pushl  0xc(%ebp)
 929:	ff 55 08             	call   *0x8(%ebp)
  current_thread->state = ZOMBIE;
 92c:	a1 00 0f 00 00       	mov    0xf00,%eax
  thread_yield();
 931:	83 c4 10             	add    $0x10,%esp
  current_thread->state = ZOMBIE;
 934:	c7 40 04 03 00 00 00 	movl   $0x3,0x4(%eax)
}
 93b:	c9                   	leave  
  thread_yield();
 93c:	e9 2f ff ff ff       	jmp    870 <thread_yield>
...
int thread_join(tid_t tid) {
 ...
 95c:	83 fe 07             	cmp    $0x7,%esi
 95f:	77 6f                	ja     9d0 <thread_join+0x80>

  while (thread_table[tid].state != ZOMBIE && thread_table[tid].state != UNUSED) {
 961:	89 f3                	mov    %esi,%ebx
 963:	c1 e3 04             	shl    $0x4,%ebx
 966:	81 c3 20 0f 00 00    	add    $0xf20,%ebx
 96c:	8b 43 04             	mov    0x4(%ebx),%eax
 96f:	83 f8 03             	cmp    $0x3,%eax
 972:	75 19                	jne    98d <thread_join+0x3d>
 974:	eb 1b                	jmp    991 <thread_join+0x41>
 976:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 97d:	8d 76 00             	lea    0x0(%esi),%esi
    thread_yield();
 980:	e8 eb fe ff ff       	call   870 <thread_yield>
  while (thread_table[tid].state != ZOMBIE && thread_table[tid].state != UNUSED) {
 985:	8b 43 04             	mov    0x4(%ebx),%eax
 988:	83 f8 03             	cmp    $0x3,%eax
 98b:	74 04                	je     991 <thread_join+0x41>
 98d:	85 c0                	test   %eax,%eax
 98f:	75 ef                	jne    980 <thread_join+0x30>
  ...
  return 0;
 991:	31 db                	xor    %ebx,%ebx
  if (thread_table[tid].state == ZOMBIE) {
 993:	83 f8 03             	cmp    $0x3,%eax
 996:	74 10                	je     9a8 <thread_join+0x58>
 ...
 9a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    free(thread_table[tid].stack);
 9a8:	c1 e6 04             	shl    $0x4,%esi
 9ab:	83 ec 0c             	sub    $0xc,%esp
 9ae:	ff b6 20 0f 00 00    	pushl  0xf20(%esi)
 9b4:	e8 17 fc ff ff       	call   5d0 <free>
    thread_table[tid].state = UNUSED;
 9b9:	83 c4 10             	add    $0x10,%esp
 9bc:	89 d8                	mov    %ebx,%eax
    thread_table[tid].state = UNUSED;
 9be:	c7 86 24 0f 00 00 00 	movl   $0x0,0xf24(%esi)
 9c5:	00 00 00 
 ...
 9cf:	c3                   	ret    
  if (tid < 0 || tid >= MAX_THREADS) return -1;
 9d0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
 9d5:	eb c1                	jmp    998 <thread_join+0x48>
...
void mutex_lock(umutex_t *m) {
 ...
 9f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  while (m->locked) {
 9fa:	8b 13                	mov    (%ebx),%edx
 9fc:	85 d2                	test   %edx,%edx
 9fe:	74 0b                	je     a0b <mutex_lock+0x1b>
    thread_yield();
 a00:	e8 6b fe ff ff       	call   870 <thread_yield>
  while (m->locked) {
 a05:	8b 03                	mov    (%ebx),%eax
 a07:	85 c0                	test   %eax,%eax
 a09:	75 f5                	jne    a00 <mutex_lock+0x10>
  }
  m->locked = 1;
 a0b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
}
...
uswtch:
movl 4(%esp), %eax
 a2e:	8b 44 24 04          	mov    0x4(%esp),%eax
movl 8(%esp), %edx
 a32:	8b 54 24 08          	mov    0x8(%esp),%edx
pushl %ebp
 a36:	55                   	push   %ebp
pushl %ebx
 a37:	53                   	push   %ebx
...
pushl %edi
 a39:	57                   	push   %edi
movl %esp, (%eax)
 a3a:	89 20                	mov    %esp,(%eax)
movl %edx, %esp
 a3c:	89 d4                	mov    %edx,%esp
popl %edi
 a3e:	5f                   	pop    %edi
popl %esi
 a3f:	5e                   	pop    %esi
