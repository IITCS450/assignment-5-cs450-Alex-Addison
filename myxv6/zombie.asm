 ...
 33c:	89 d1                	mov    %edx,%ecx
{
 ...
 369:	0f b6 92 54 0a 00 00 	movzbl 0xa54(%edx),%edx
 ...
 3e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 459:	ff 24 85 fc 09 00 00 	jmp    *0x9fc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 567:	90                   	nop
          s = "(null)";
 568:	ba f4 09 00 00       	mov    $0x9f4,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 581:	a1 40 0e 00 00       	mov    0xe40,%eax
{
 ...
 5c1:	5b                   	pop    %ebx
  freep = p;
 5c2:	89 15 40 0e 00 00    	mov    %edx,0xe40
}
 5c8:	5e                   	pop    %esi
 5c9:	5f                   	pop    %edi
 5ca:	5d                   	pop    %ebp
 ...
 5f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 5fc:	89 15 40 0e 00 00    	mov    %edx,0xe40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 3d 40 0e 00 00    	mov    0xe40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 65f:	73 4f                	jae    6b0 <malloc+0xa0>
    ...
    if(p == freep)
 661:	8b 3d 40 0e 00 00    	mov    0xe40,%edi
 ...
 68a:	e8 f1 fe ff ff       	call   580 <free>
  return freep;
 68f:	8b 15 40 0e 00 00    	mov    0xe40,%edx
 ...
 6d7:	0e 00 00 
    base.s.size = 0;
 6da:	bf 44 0e 00 00       	mov    $0xe44,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 6e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6eb:	c7 05 48 0e 00 00 00 	movl   $0x0,0xe48
 6f2:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
 ...
 710:	c7 05 94 0e 00 00 00 	movl   $0x0,0xe94
 717:	00 00 00 
 71a:	c7 05 a4 0e 00 00 00 	movl   $0x0,0xea4
 721:	00 00 00 
 724:	c7 05 b4 0e 00 00 00 	movl   $0x0,0xeb4
 72b:	00 00 00 
 72e:	c7 05 c4 0e 00 00 00 	movl   $0x0,0xec4
 735:	00 00 00 
 738:	c7 05 d4 0e 00 00 00 	movl   $0x0,0xed4
 73f:	00 00 00 
 742:	c7 05 e4 0e 00 00 00 	movl   $0x0,0xee4
 749:	00 00 00 
 74c:	c7 05 f4 0e 00 00 00 	movl   $0x0,0xef4
 753:	00 00 00 
  }
  current_thread = &thread_table[0];
 756:	c7 05 60 0e 00 00 80 	movl   $0xe80,0xe60
 75d:	0e 00 00 
  current_thread->state = RUNNING;
 760:	c7 05 84 0e 00 00 02 	movl   $0x2,0xe84
 767:	00 00 00 
  current_thread->tid = 0;
 76a:	c7 05 8c 0e 00 00 00 	movl   $0x0,0xe8c
 771:	00 00 00 
}
 774:	c3                   	ret    
 775:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 792:	c1 e3 04             	shl    $0x4,%ebx
 795:	8b 93 84 0e 00 00    	mov    0xe84(%ebx),%edx
 79b:	85 d2                	test   %edx,%edx
 79d:	74 19                	je     7b8 <thread_create+0x38>
  for (i = 0; i < MAX_THREADS; i++) {
 79f:	83 c0 01             	add    $0x1,%eax
 7a2:	83 f8 08             	cmp    $0x8,%eax
 7a5:	75 e9                	jne    790 <thread_create+0x10>
 ...
 7a7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  if (!t) return -1;
 7aa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 7af:	c9                   	leave  
 7b0:	c3                   	ret    
 ...
 7bb:	68 00 10 00 00       	push   $0x1000
 7c0:	e8 4b fe ff ff       	call   610 <malloc>
  sp -= 4; *(uint*)sp = (uint)arg;
 7c5:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  t->tid = (int)(t - thread_table);
 7c8:	83 c4 10             	add    $0x10,%esp
  t->state = RUNNABLE;
 7cb:	c7 83 84 0e 00 00 01 	movl   $0x1,0xe84(%ebx)
 7d2:	00 00 00 
  t->stack = malloc(STACK_SIZE);
 7d5:	89 83 80 0e 00 00    	mov    %eax,0xe80(%ebx)
  sp -= 4; *(uint*)sp = (uint)arg;
 7db:	89 88 fc 0f 00 00    	mov    %ecx,0xffc(%eax)
  sp -= 4; *(uint*)sp = (uint)fn;
 7e1:	8b 4d 08             	mov    0x8(%ebp),%ecx
  sp -= 4; *(uint*)sp = 0;
 7e4:	c7 80 f4 0f 00 00 00 	movl   $0x0,0xff4(%eax)
 7eb:	00 00 00 
  sp -= 4; *(uint*)sp = (uint)fn;
 7ee:	89 88 f8 0f 00 00    	mov    %ecx,0xff8(%eax)
  sp -= sizeof(struct context);
 7f4:	8d 88 e0 0f 00 00    	lea    0xfe0(%eax),%ecx
  t->context->eip = (uint)thread_stub;
 7fa:	c7 80 f0 0f 00 00 d0 	movl   $0x8d0,0xff0(%eax)
 801:	08 00 00 
  t->tid = (int)(t - thread_table);
 804:	89 d8                	mov    %ebx,%eax
 806:	c1 f8 04             	sar    $0x4,%eax
  sp -= sizeof(struct context);
 809:	89 8b 88 0e 00 00    	mov    %ecx,0xe88(%ebx)
  t->tid = (int)(t - thread_table);
 80f:	89 83 8c 0e 00 00    	mov    %eax,0xe8c(%ebx)
}
...
void thread_yield(void) {
 ...
 829:	8b 35 60 0e 00 00    	mov    0xe60,%esi
  struct thread *next = 0;
  int i, idx;
  int start = (prev->tid + 1) % MAX_THREADS;
 82f:	8b 46 0c             	mov    0xc(%esi),%eax
 832:	83 c0 01             	add    $0x1,%eax
 835:	99                   	cltd   
 836:	c1 ea 1d             	shr    $0x1d,%edx
 839:	01 d0                	add    %edx,%eax
 83b:	83 e0 07             	and    $0x7,%eax
 83e:	29 d0                	sub    %edx,%eax
 840:	8d 58 08             	lea    0x8(%eax),%ebx
 ...
 84a:	c1 f9 1f             	sar    $0x1f,%ecx
 84d:	c1 e9 1d             	shr    $0x1d,%ecx
 850:	8d 14 08             	lea    (%eax,%ecx,1),%edx
 853:	83 e2 07             	and    $0x7,%edx
 856:	29 ca                	sub    %ecx,%edx
    if (thread_table[idx].state == RUNNABLE) {
 858:	89 d1                	mov    %edx,%ecx
 85a:	c1 e1 04             	shl    $0x4,%ecx
 85d:	83 b9 84 0e 00 00 01 	cmpl   $0x1,0xe84(%ecx)
 864:	8d b9 80 0e 00 00    	lea    0xe80(%ecx),%edi
 86a:	74 14                	je     880 <thread_yield+0x60>
  for (i = 0; i < MAX_THREADS; i++) {
 86c:	83 c0 01             	add    $0x1,%eax
 86f:	39 c3                	cmp    %eax,%ebx
 871:	75 d5                	jne    848 <thread_yield+0x28>
 ...
 87f:	90                   	nop
  if (next && next != prev) {
 880:	39 fe                	cmp    %edi,%esi
 882:	74 ef                	je     873 <thread_yield+0x53>
    if (prev->state == RUNNING) prev->state = RUNNABLE;
 884:	83 7e 04 02          	cmpl   $0x2,0x4(%esi)
 888:	74 36                	je     8c0 <thread_yield+0xa0>
    uswtch(&prev->context, next->context);
 88a:	83 ec 08             	sub    $0x8,%esp
    next->state = RUNNING;
 88d:	c1 e2 04             	shl    $0x4,%edx
    uswtch(&prev->context, next->context);
 890:	83 c6 08             	add    $0x8,%esi
    current_thread = next;
 893:	89 3d 60 0e 00 00    	mov    %edi,0xe60
    uswtch(&prev->context, next->context);
 899:	ff b2 88 0e 00 00    	pushl  0xe88(%edx)
 89f:	56                   	push   %esi
    next->state = RUNNING;
 8a0:	c7 82 84 0e 00 00 02 	movl   $0x2,0xe84(%edx)
 8a7:	00 00 00 
    uswtch(&prev->context, next->context);
 8aa:	e8 2f 01 00 00       	call   9de <uswtch>
 8af:	83 c4 10             	add    $0x10,%esp
}
 8b2:	8d 65 f4             	lea    -0xc(%ebp),%esp
 8b5:	5b                   	pop    %ebx
 8b6:	5e                   	pop    %esi
 8b7:	5f                   	pop    %edi
 8b8:	5d                   	pop    %ebp
 ...
 8ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if (prev->state == RUNNING) prev->state = RUNNABLE;
 8c0:	c7 46 04 01 00 00 00 	movl   $0x1,0x4(%esi)
 8c7:	eb c1                	jmp    88a <thread_yield+0x6a>
 8c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

000008d0 <thread_stub>:
void thread_stub(void (*fn)(void*), void *arg) {
 8d0:	55                   	push   %ebp
 8d1:	89 e5                	mov    %esp,%ebp
 8d3:	83 ec 14             	sub    $0x14,%esp
  fn(arg);
 8d6:	ff 75 0c             	pushl  0xc(%ebp)
 8d9:	ff 55 08             	call   *0x8(%ebp)
  current_thread->state = ZOMBIE;
 8dc:	a1 60 0e 00 00       	mov    0xe60,%eax
  thread_yield();
 8e1:	83 c4 10             	add    $0x10,%esp
  current_thread->state = ZOMBIE;
 8e4:	c7 40 04 03 00 00 00 	movl   $0x3,0x4(%eax)
}
 8eb:	c9                   	leave  
  thread_yield();
 8ec:	e9 2f ff ff ff       	jmp    820 <thread_yield>
 8f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 8f8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 8ff:	90                   	nop

00000900 <thread_join>:
...
int thread_join(tid_t tid) {
 ...
 90c:	83 fe 07             	cmp    $0x7,%esi
 90f:	77 6f                	ja     980 <thread_join+0x80>

  while (thread_table[tid].state != ZOMBIE && thread_table[tid].state != UNUSED) {
 911:	89 f3                	mov    %esi,%ebx
 913:	c1 e3 04             	shl    $0x4,%ebx
 916:	81 c3 80 0e 00 00    	add    $0xe80,%ebx
 91c:	8b 43 04             	mov    0x4(%ebx),%eax
 91f:	83 f8 03             	cmp    $0x3,%eax
 922:	75 19                	jne    93d <thread_join+0x3d>
 924:	eb 1b                	jmp    941 <thread_join+0x41>
 926:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 92d:	8d 76 00             	lea    0x0(%esi),%esi
    thread_yield();
 930:	e8 eb fe ff ff       	call   820 <thread_yield>
  while (thread_table[tid].state != ZOMBIE && thread_table[tid].state != UNUSED) {
 935:	8b 43 04             	mov    0x4(%ebx),%eax
 938:	83 f8 03             	cmp    $0x3,%eax
 93b:	74 04                	je     941 <thread_join+0x41>
 93d:	85 c0                	test   %eax,%eax
 93f:	75 ef                	jne    930 <thread_join+0x30>
 ...
 941:	31 db                	xor    %ebx,%ebx
  if (thread_table[tid].state == ZOMBIE) {
 943:	83 f8 03             	cmp    $0x3,%eax
 946:	74 10                	je     958 <thread_join+0x58>
 948:	8d 65 f4             	lea    -0xc(%ebp),%esp
 94b:	89 d8                	mov    %ebx,%eax
 94d:	5b                   	pop    %ebx
 94e:	5e                   	pop    %esi
 94f:	5f                   	pop    %edi
 950:	5d                   	pop    %ebp
 ...
 952:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    free(thread_table[tid].stack);
 958:	c1 e6 04             	shl    $0x4,%esi
 95b:	83 ec 0c             	sub    $0xc,%esp
 95e:	ff b6 80 0e 00 00    	pushl  0xe80(%esi)
 964:	e8 17 fc ff ff       	call   580 <free>
    thread_table[tid].state = UNUSED;
 969:	83 c4 10             	add    $0x10,%esp
 96c:	89 d8                	mov    %ebx,%eax
    thread_table[tid].state = UNUSED;
 96e:	c7 86 84 0e 00 00 00 	movl   $0x0,0xe84(%esi)
 975:	00 00 00 
 ...
 97f:	c3                   	ret    
  if (tid < 0 || tid >= MAX_THREADS) return -1;
 980:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
 985:	eb c1                	jmp    948 <thread_join+0x48>
...
void mutex_lock(umutex_t *m) {
 ...
 9a7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  while (m->locked) {
 9aa:	8b 13                	mov    (%ebx),%edx
 9ac:	85 d2                	test   %edx,%edx
 9ae:	74 0b                	je     9bb <mutex_lock+0x1b>
    thread_yield();
 9b0:	e8 6b fe ff ff       	call   820 <thread_yield>
  while (m->locked) {
 9b5:	8b 03                	mov    (%ebx),%eax
 9b7:	85 c0                	test   %eax,%eax
 9b9:	75 f5                	jne    9b0 <mutex_lock+0x10>
  }
  m->locked = 1;
 9bb:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
}
...
uswtch:
movl 4(%esp), %eax
 9de:	8b 44 24 04          	mov    0x4(%esp),%eax
movl 8(%esp), %edx
 9e2:	8b 54 24 08          	mov    0x8(%esp),%edx
pushl %ebp
 9e6:	55                   	push   %ebp
pushl %ebx
 9e7:	53                   	push   %ebx
...
pushl %edi
 9e9:	57                   	push   %edi
movl %esp, (%eax)
 9ea:	89 20                	mov    %esp,(%eax)
movl %edx, %esp
 9ec:	89 d4                	mov    %edx,%esp
popl %edi
 9ee:	5f                   	pop    %edi
popl %esi
 9ef:	5e                   	pop    %esi
