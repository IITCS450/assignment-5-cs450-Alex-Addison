...
000001d0 <grep>:
{
 ...
 1fd:	50                   	push   %eax
 1fe:	8d 81 c0 12 00 00    	lea    0x12c0(%ecx),%eax
 204:	50                   	push   %eax
 ...
 21b:	8b 4d dc             	mov    -0x24(%ebp),%ecx
    p = buf;
 21e:	c7 45 e4 c0 12 00 00 	movl   $0x12c0,-0x1c(%ebp)
    buf[m] = '\0';
 225:	c6 81 c0 12 00 00 00 	movb   $0x0,0x12c0(%ecx)
    while((q = strchr(p, '\n')) != 0){
 ...
 2bb:	81 fa c0 12 00 00    	cmp    $0x12c0,%edx
 ...
 2d0:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2d3:	2d c0 12 00 00       	sub    $0x12c0,%eax
 2d8:	29 c1                	sub    %eax,%ecx
      memmove(buf, p, m);
 2da:	51                   	push   %ecx
 2db:	52                   	push   %edx
 2dc:	68 c0 12 00 00       	push   $0x12c0
      m -= p - buf;
 ...
 67c:	89 d1                	mov    %edx,%ecx
{
 ...
 6a9:	0f b6 92 cc 0d 00 00 	movzbl 0xdcc(%edx),%edx
 ...
 729:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 799:	ff 24 85 74 0d 00 00 	jmp    *0xd74(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8a7:	90                   	nop
          s = "(null)";
 8a8:	ba 6a 0d 00 00       	mov    $0xd6a,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8c1:	a1 c0 16 00 00       	mov    0x16c0,%eax
{
 ...
 901:	5b                   	pop    %ebx
  freep = p;
 902:	89 15 c0 16 00 00    	mov    %edx,0x16c0
}
 908:	5e                   	pop    %esi
 909:	5f                   	pop    %edi
 90a:	5d                   	pop    %ebp
 ...
 939:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 93c:	89 15 c0 16 00 00    	mov    %edx,0x16c0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 959:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 95c:	8b 3d c0 16 00 00    	mov    0x16c0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 99f:	73 4f                	jae    9f0 <malloc+0xa0>
    ...
    if(p == freep)
 9a1:	8b 3d c0 16 00 00    	mov    0x16c0,%edi
 ...
 9ca:	e8 f1 fe ff ff       	call   8c0 <free>
  return freep;
 9cf:	8b 15 c0 16 00 00    	mov    0x16c0,%edx
 ...
 9fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 9ff:	89 15 c0 16 00 00    	mov    %edx,0x16c0
}
 ...
 a0f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a10:	c7 05 c0 16 00 00 c4 	movl   $0x16c4,0x16c0
 a17:	16 00 00 
    base.s.size = 0;
 a1a:	bf c4 16 00 00       	mov    $0x16c4,%edi
    base.s.ptr = freep = prevp = &base;
 a1f:	c7 05 c4 16 00 00 c4 	movl   $0x16c4,0x16c4
 a26:	16 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a29:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a2b:	c7 05 c8 16 00 00 00 	movl   $0x0,0x16c8
 a32:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
 ...
 a50:	c7 05 14 17 00 00 00 	movl   $0x0,0x1714
 a57:	00 00 00 
 a5a:	c7 05 24 17 00 00 00 	movl   $0x0,0x1724
 a61:	00 00 00 
 a64:	c7 05 34 17 00 00 00 	movl   $0x0,0x1734
 a6b:	00 00 00 
 a6e:	c7 05 44 17 00 00 00 	movl   $0x0,0x1744
 a75:	00 00 00 
 a78:	c7 05 54 17 00 00 00 	movl   $0x0,0x1754
 a7f:	00 00 00 
 a82:	c7 05 64 17 00 00 00 	movl   $0x0,0x1764
 a89:	00 00 00 
 a8c:	c7 05 74 17 00 00 00 	movl   $0x0,0x1774
 a93:	00 00 00 
  }
  current_thread = &thread_table[0];
 a96:	c7 05 e0 16 00 00 00 	movl   $0x1700,0x16e0
 a9d:	17 00 00 
  current_thread->state = RUNNING;
 aa0:	c7 05 04 17 00 00 02 	movl   $0x2,0x1704
 aa7:	00 00 00 
  current_thread->tid = 0;
 aaa:	c7 05 0c 17 00 00 00 	movl   $0x0,0x170c
 ab1:	00 00 00 
}
 ab4:	c3                   	ret    
 ab5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 abc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

00000ac0 <thread_create>:
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 ad0:	89 c3                	mov    %eax,%ebx
 ad2:	c1 e3 04             	shl    $0x4,%ebx
 ad5:	8b 93 04 17 00 00    	mov    0x1704(%ebx),%edx
 adb:	85 d2                	test   %edx,%edx
 add:	74 19                	je     af8 <thread_create+0x38>
  for (i = 0; i < MAX_THREADS; i++) {
 adf:	83 c0 01             	add    $0x1,%eax
 ae2:	83 f8 08             	cmp    $0x8,%eax
 ae5:	75 e9                	jne    ad0 <thread_create+0x10>
 ...
 afb:	68 00 10 00 00       	push   $0x1000
 b00:	e8 4b fe ff ff       	call   950 <malloc>
  sp -= 4; *(uint*)sp = (uint)arg;
 b05:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  t->tid = (int)(t - thread_table);
 b08:	83 c4 10             	add    $0x10,%esp
  t->state = RUNNABLE;
 b0b:	c7 83 04 17 00 00 01 	movl   $0x1,0x1704(%ebx)
 b12:	00 00 00 
  t->stack = malloc(STACK_SIZE);
 b15:	89 83 00 17 00 00    	mov    %eax,0x1700(%ebx)
  sp -= 4; *(uint*)sp = (uint)arg;
 b1b:	89 88 fc 0f 00 00    	mov    %ecx,0xffc(%eax)
  sp -= 4; *(uint*)sp = (uint)fn;
 b21:	8b 4d 08             	mov    0x8(%ebp),%ecx
  sp -= 4; *(uint*)sp = 0;
 b24:	c7 80 f4 0f 00 00 00 	movl   $0x0,0xff4(%eax)
 b2b:	00 00 00 
  sp -= 4; *(uint*)sp = (uint)fn;
 b2e:	89 88 f8 0f 00 00    	mov    %ecx,0xff8(%eax)
  sp -= sizeof(struct context);
 b34:	8d 88 e0 0f 00 00    	lea    0xfe0(%eax),%ecx
  t->context->eip = (uint)thread_stub;
 b3a:	c7 80 f0 0f 00 00 10 	movl   $0xc10,0xff0(%eax)
 b41:	0c 00 00 
  t->tid = (int)(t - thread_table);
 b44:	89 d8                	mov    %ebx,%eax
 b46:	c1 f8 04             	sar    $0x4,%eax
  sp -= sizeof(struct context);
 b49:	89 8b 08 17 00 00    	mov    %ecx,0x1708(%ebx)
  t->tid = (int)(t - thread_table);
 b4f:	89 83 0c 17 00 00    	mov    %eax,0x170c(%ebx)
}
...
void thread_yield(void) {
 ...
 b69:	8b 35 e0 16 00 00    	mov    0x16e0,%esi
 ...
 b75:	99                   	cltd   
 b76:	c1 ea 1d             	shr    $0x1d,%edx
 b79:	01 d0                	add    %edx,%eax
 b7b:	83 e0 07             	and    $0x7,%eax
 b7e:	29 d0                	sub    %edx,%eax
 b80:	8d 58 08             	lea    0x8(%eax),%ebx
 ...
 b8a:	c1 f9 1f             	sar    $0x1f,%ecx
 b8d:	c1 e9 1d             	shr    $0x1d,%ecx
 b90:	8d 14 08             	lea    (%eax,%ecx,1),%edx
 b93:	83 e2 07             	and    $0x7,%edx
 b96:	29 ca                	sub    %ecx,%edx
    if (thread_table[idx].state == RUNNABLE) {
 b98:	89 d1                	mov    %edx,%ecx
 b9a:	c1 e1 04             	shl    $0x4,%ecx
 b9d:	83 b9 04 17 00 00 01 	cmpl   $0x1,0x1704(%ecx)
 ba4:	8d b9 00 17 00 00    	lea    0x1700(%ecx),%edi
 baa:	74 14                	je     bc0 <thread_yield+0x60>
  for (i = 0; i < MAX_THREADS; i++) {
 bac:	83 c0 01             	add    $0x1,%eax
 baf:	39 c3                	cmp    %eax,%ebx
 bb1:	75 d5                	jne    b88 <thread_yield+0x28>
 ...
 bbf:	90                   	nop
  if (next && next != prev) {
 bc0:	39 fe                	cmp    %edi,%esi
 bc2:	74 ef                	je     bb3 <thread_yield+0x53>
    if (prev->state == RUNNING) prev->state = RUNNABLE;
 bc4:	83 7e 04 02          	cmpl   $0x2,0x4(%esi)
 bc8:	74 36                	je     c00 <thread_yield+0xa0>
    uswtch(&prev->context, next->context);
 bca:	83 ec 08             	sub    $0x8,%esp
    next->state = RUNNING;
 bcd:	c1 e2 04             	shl    $0x4,%edx
    uswtch(&prev->context, next->context);
 bd0:	83 c6 08             	add    $0x8,%esi
    current_thread = next;
 bd3:	89 3d e0 16 00 00    	mov    %edi,0x16e0
    uswtch(&prev->context, next->context);
 bd9:	ff b2 08 17 00 00    	pushl  0x1708(%edx)
 bdf:	56                   	push   %esi
    next->state = RUNNING;
 be0:	c7 82 04 17 00 00 02 	movl   $0x2,0x1704(%edx)
 be7:	00 00 00 
    uswtch(&prev->context, next->context);
 bea:	e8 2f 01 00 00       	call   d1e <uswtch>
 bef:	83 c4 10             	add    $0x10,%esp
}
 bf2:	8d 65 f4             	lea    -0xc(%ebp),%esp
 bf5:	5b                   	pop    %ebx
 bf6:	5e                   	pop    %esi
 bf7:	5f                   	pop    %edi
 bf8:	5d                   	pop    %ebp
 ...
 bfa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if (prev->state == RUNNING) prev->state = RUNNABLE;
 c00:	c7 46 04 01 00 00 00 	movl   $0x1,0x4(%esi)
 c07:	eb c1                	jmp    bca <thread_yield+0x6a>
 c09:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00000c10 <thread_stub>:
void thread_stub(void (*fn)(void*), void *arg) {
 ...
 c19:	ff 55 08             	call   *0x8(%ebp)
  current_thread->state = ZOMBIE;
 c1c:	a1 e0 16 00 00       	mov    0x16e0,%eax
  thread_yield();
 c21:	83 c4 10             	add    $0x10,%esp
  current_thread->state = ZOMBIE;
 c24:	c7 40 04 03 00 00 00 	movl   $0x3,0x4(%eax)
}
 c2b:	c9                   	leave  
  thread_yield();
 c2c:	e9 2f ff ff ff       	jmp    b60 <thread_yield>
...
int thread_join(tid_t tid) {
 ...
 c49:	8b 75 08             	mov    0x8(%ebp),%esi
  if (tid < 0 || tid >= MAX_THREADS) return -1;
 c4c:	83 fe 07             	cmp    $0x7,%esi
 c4f:	77 6f                	ja     cc0 <thread_join+0x80>

  while (thread_table[tid].state != ZOMBIE && thread_table[tid].state != UNUSED) {
 c51:	89 f3                	mov    %esi,%ebx
 c53:	c1 e3 04             	shl    $0x4,%ebx
 c56:	81 c3 00 17 00 00    	add    $0x1700,%ebx
 c5c:	8b 43 04             	mov    0x4(%ebx),%eax
 c5f:	83 f8 03             	cmp    $0x3,%eax
 c62:	75 19                	jne    c7d <thread_join+0x3d>
 c64:	eb 1b                	jmp    c81 <thread_join+0x41>
 c66:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 c6d:	8d 76 00             	lea    0x0(%esi),%esi
    thread_yield();
 c70:	e8 eb fe ff ff       	call   b60 <thread_yield>
  while (thread_table[tid].state != ZOMBIE && thread_table[tid].state != UNUSED) {
 c75:	8b 43 04             	mov    0x4(%ebx),%eax
 c78:	83 f8 03             	cmp    $0x3,%eax
 c7b:	74 04                	je     c81 <thread_join+0x41>
 c7d:	85 c0                	test   %eax,%eax
 c7f:	75 ef                	jne    c70 <thread_join+0x30>
  ...
  return 0;
 c81:	31 db                	xor    %ebx,%ebx
  if (thread_table[tid].state == ZOMBIE) {
 c83:	83 f8 03             	cmp    $0x3,%eax
 c86:	74 10                	je     c98 <thread_join+0x58>
 ...
 c92:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    free(thread_table[tid].stack);
 c98:	c1 e6 04             	shl    $0x4,%esi
 c9b:	83 ec 0c             	sub    $0xc,%esp
 c9e:	ff b6 00 17 00 00    	pushl  0x1700(%esi)
 ca4:	e8 17 fc ff ff       	call   8c0 <free>
    thread_table[tid].state = UNUSED;
 ca9:	83 c4 10             	add    $0x10,%esp
 cac:	89 d8                	mov    %ebx,%eax
    thread_table[tid].state = UNUSED;
 cae:	c7 86 04 17 00 00 00 	movl   $0x0,0x1704(%esi)
 cb5:	00 00 00 
 ...
 cbf:	c3                   	ret    
  if (tid < 0 || tid >= MAX_THREADS) return -1;
 cc0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
 cc5:	eb c1                	jmp    c88 <thread_join+0x48>
...
void mutex_init(umutex_t *m) {
 ...
 cd6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 cdc:	5d                   	pop    %ebp
 cdd:	c3                   	ret    
...
void mutex_lock(umutex_t *m) {
 ...
 ce7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  while (m->locked) {
 cea:	8b 13                	mov    (%ebx),%edx
 cec:	85 d2                	test   %edx,%edx
 cee:	74 0b                	je     cfb <mutex_lock+0x1b>
    thread_yield();
 cf0:	e8 6b fe ff ff       	call   b60 <thread_yield>
  while (m->locked) {
 cf5:	8b 03                	mov    (%ebx),%eax
 cf7:	85 c0                	test   %eax,%eax
 cf9:	75 f5                	jne    cf0 <mutex_lock+0x10>
  }
  m->locked = 1;
 cfb:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
}
 d01:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 d04:	c9                   	leave  
 d05:	c3                   	ret    
 d06:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 d0d:	8d 76 00             	lea    0x0(%esi),%esi

00000d10 <mutex_unlock>:
 d10:	55                   	push   %ebp
 d11:	89 e5                	mov    %esp,%ebp
 d13:	8b 45 08             	mov    0x8(%ebp),%eax
 d16:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
 d1c:	5d                   	pop    %ebp
 d1d:	c3                   	ret    
...
uswtch:
movl 4(%esp), %eax
 d1e:	8b 44 24 04          	mov    0x4(%esp),%eax
movl 8(%esp), %edx
 d22:	8b 54 24 08          	mov    0x8(%esp),%edx
pushl %ebp
 d26:	55                   	push   %ebp
pushl %ebx
 d27:	53                   	push   %ebx
...
pushl %edi
 d29:	57                   	push   %edi
movl %esp, (%eax)
 d2a:	89 20                	mov    %esp,(%eax)
movl %edx, %esp
 d2c:	89 d4                	mov    %edx,%esp
popl %edi
 d2e:	5f                   	pop    %edi
popl %esi
 d2f:	5e                   	pop    %esi
